/*** Zen Module: ZEN_Mojo_Plugin_highCharts404Helper ***/

self._zenClassIdx['http://www.intersystems.com/zen/mojo/highCharts-4.0.4-Helper'] = '_ZEN_Mojo_Plugin_highCharts404Helper';
self._ZEN_Mojo_Plugin_highCharts404Helper = function(index,id) {
	if (index>=0) {_ZEN_Mojo_Plugin_highCharts404Helper__init(this,index,id);}
}

self._ZEN_Mojo_Plugin_highCharts404Helper__init = function(o,index,id) {
	...
	o.pluginName = 'highCharts-4.0.4-Helper';
	o.version = '1.0.2';
}
function _ZEN_Mojo_Plugin_highCharts404Helper_serialize(set,s)
{
...
function _ZEN_Mojo_Plugin_highCharts404Helper_getSettings(s)
{
	s['name'] = 'string';
	s['pluginName'] = 'string';
	s['version'] = 'string';
...
self._ZEN_Mojo_Plugin_highCharts404Helper_createLayoutObjects = function(type,instance) {
...
self._ZEN_Mojo_Plugin_highCharts404Helper_getFeatures = function() {
var features = [
{identifier:'$chart'},
...
self._ZEN_Mojo_Plugin_highCharts404Helper_initializeChart = function() {
var instance = this;
...
self._ZEN_Mojo_Plugin_highCharts404Helper_onCheckLibraries = function() {
if (typeof $ === 'undefined') {
...
self._ZEN_Mojo_Plugin_highCharts404Helper_renderChart = function() {
var html = [];
...
self._ZEN_Mojo_Plugin_highCharts404Helper__Loader = function() {
	zenLoadClass('_ZEN_Mojo_Plugin_baseHelperPlugin');
	_ZEN_Mojo_Plugin_highCharts404Helper.prototype = zenCreate('_ZEN_Mojo_Plugin_baseHelperPlugin',-1);
	var p = _ZEN_Mojo_Plugin_highCharts404Helper.prototype;
	if (null==p) {return;}
	p.constructor = _ZEN_Mojo_Plugin_highCharts404Helper;
	...
	p._serverClass = '%ZEN.Mojo.Plugin.highCharts404Helper';
	p._type = 'highCharts404Helper';
	p.serialize = _ZEN_Mojo_Plugin_highCharts404Helper_serialize;
	p.getSettings = _ZEN_Mojo_Plugin_highCharts404Helper_getSettings;
	p.createLayoutObjects = _ZEN_Mojo_Plugin_highCharts404Helper_createLayoutObjects;
	p.getFeatures = _ZEN_Mojo_Plugin_highCharts404Helper_getFeatures;
	p.initializeChart = _ZEN_Mojo_Plugin_highCharts404Helper_initializeChart;
	p.onCheckLibraries = _ZEN_Mojo_Plugin_highCharts404Helper_onCheckLibraries;
	p.renderChart = _ZEN_Mojo_Plugin_highCharts404Helper_renderChart;
}
/* EOF */