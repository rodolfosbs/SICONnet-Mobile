/*** Zen Module: ZEN_Mojo_Plugin_chuiHelper ***/

self._zenClassIdx['http://www.intersystems.com/zen/mojo/chuiHelper'] = '_ZEN_Mojo_Plugin_chuiHelper';
self._ZEN_Mojo_Plugin_chuiHelper = function(index,id) {
	if (index>=0) {_ZEN_Mojo_Plugin_chuiHelper__init(this,index,id);}
}

self._ZEN_Mojo_Plugin_chuiHelper__init = function(o,index,id) {
	...
	o.pluginName = 'chuiHelper';
	o.version = '0.5.5';
}
function _ZEN_Mojo_Plugin_chuiHelper_serialize(set,s)
{
...
function _ZEN_Mojo_Plugin_chuiHelper_getSettings(s)
{
	s['name'] = 'string';
	s['pluginName'] = 'string';
	s['version'] = 'string';
...
self._ZEN_Mojo_Plugin_chuiHelper_createLayoutObjects = function(type,instance) {
...
self._ZEN_Mojo_Plugin_chuiHelper_getFeatures = function() {
var features = [
{identifier:'$article'},
{identifier:'$aside'},
{identifier:'$button'},
...
self._ZEN_Mojo_Plugin_chuiHelper_onCheckLibraries = function() {
if (typeof $ === 'undefined') {
...
self._ZEN_Mojo_Plugin_chuiHelper_renderArticle = function() {
var html = [];
...
self._ZEN_Mojo_Plugin_chuiHelper_renderAside = function() {
var html = [];
var docView = this.$documentView;
...
self._ZEN_Mojo_Plugin_chuiHelper_renderButton = function() {
var html = [];
var docView = this.$documentView;
var hidden = zenGet(this.hidden,false);
...
self._ZEN_Mojo_Plugin_chuiHelper_renderDiv = function() {
var html = [];
var docView = this.$documentView;
var hidden = zenGet(this.hidden,false);
var cssClass = zenGet(this.cssClass,'');
...
self._ZEN_Mojo_Plugin_chuiHelper_renderH = function() {
var html = [];
var docView = this.$documentView;
var hidden = zenGet(this.hidden,false) ? 'hidden' : '';
var caption = zenGet(this.caption,'');
...
self._ZEN_Mojo_Plugin_chuiHelper_renderLink = function() {
var html = [];
var docView = this.$documentView;
var hidden = zenGet(this.hidden,false);
var caption = zenGet(this.caption,'');
...
self._ZEN_Mojo_Plugin_chuiHelper_renderList = function() {
var html = [];
var docView = this.$documentView;
var hidden = zenGet(this.hidden,false) ? 'hidden' : '';
var caption = zenGet(this.caption,'');
...
self._ZEN_Mojo_Plugin_chuiHelper_renderListitem = function() {
var html = [];
var docView = this.$documentView;
var hidden = zenGet(this.hidden,false) ? 'hidden' : '';
var caption = zenGet(this.caption,'');
...
self._ZEN_Mojo_Plugin_chuiHelper_renderNavbar = function() {
var html = [];
var docView = this.$documentView;
var pageId = 'page'+docView.currLevel;
var hidden = zenGet(this.hidden,false) ? 'hidden' : '';
...
self._ZEN_Mojo_Plugin_chuiHelper_renderP = function() {
var html = [];
var docView = this.$documentView;
var hidden = zenGet(this.hidden,false) ? 'hidden' : '';
var caption = zenGet(this.caption,'');
...
self._ZEN_Mojo_Plugin_chuiHelper_renderSection = function() {
var html = [];
var docView = this.$documentView;
var hidden = zenGet(this.hidden,false) ? 'hidden' : '';
...
self._ZEN_Mojo_Plugin_chuiHelper__Loader = function() {
	zenLoadClass('_ZEN_Mojo_Plugin_baseHelperPlugin');
	_ZEN_Mojo_Plugin_chuiHelper.prototype = zenCreate('_ZEN_Mojo_Plugin_baseHelperPlugin',-1);
	var p = _ZEN_Mojo_Plugin_chuiHelper.prototype;
	if (null==p) {return;}
	p.constructor = _ZEN_Mojo_Plugin_chuiHelper;
	...
	p._serverClass = '%ZEN.Mojo.Plugin.chuiHelper';
	p._type = 'chuiHelper';
	p.serialize = _ZEN_Mojo_Plugin_chuiHelper_serialize;
	p.getSettings = _ZEN_Mojo_Plugin_chuiHelper_getSettings;
	p.createLayoutObjects = _ZEN_Mojo_Plugin_chuiHelper_createLayoutObjects;
	p.getFeatures = _ZEN_Mojo_Plugin_chuiHelper_getFeatures;
	p.onCheckLibraries = _ZEN_Mojo_Plugin_chuiHelper_onCheckLibraries;
	p.renderArticle = _ZEN_Mojo_Plugin_chuiHelper_renderArticle;
	p.renderAside = _ZEN_Mojo_Plugin_chuiHelper_renderAside;
	p.renderButton = _ZEN_Mojo_Plugin_chuiHelper_renderButton;
	p.renderDiv = _ZEN_Mojo_Plugin_chuiHelper_renderDiv;
	p.renderH = _ZEN_Mojo_Plugin_chuiHelper_renderH;
	p.renderLink = _ZEN_Mojo_Plugin_chuiHelper_renderLink;
	p.renderList = _ZEN_Mojo_Plugin_chuiHelper_renderList;
	p.renderListitem = _ZEN_Mojo_Plugin_chuiHelper_renderListitem;
	p.renderNavbar = _ZEN_Mojo_Plugin_chuiHelper_renderNavbar;
	p.renderP = _ZEN_Mojo_Plugin_chuiHelper_renderP;
	p.renderSection = _ZEN_Mojo_Plugin_chuiHelper_renderSection;
}
/* EOF */