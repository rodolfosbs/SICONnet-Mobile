/*** Zen Module: ZEN_Mojo_Plugin_dojo191DijitHelperDocumentation ***/

self._zenClassIdx['http://www.intersystems.com/zen/mojo/dojo191DijitHelperDocumentation'] = '_ZEN_Mojo_Plugin_dojo191DijitHelperDocumentation';
self._ZEN_Mojo_Plugin_dojo191DijitHelperDocumentation = function(index,id) {
	if (index>=0) {_ZEN_Mojo_Plugin_dojo191DijitHelperDocumentation__init(this,index,id);}
}

self._ZEN_Mojo_Plugin_dojo191DijitHelperDocumentation__init = function(o,index,id) {
...
function _ZEN_Mojo_Plugin_dojo191DijitHelperDocumentation_serialize(set,s)
{
...
function _ZEN_Mojo_Plugin_dojo191DijitHelperDocumentation_getSettings(s)
{
	s['name'] = 'string';
	this.invokeSuper('getSettings',arguments);
}

self._ZEN_Mojo_Plugin_dojo191DijitHelperDocumentation_getDocumentation = function(identifier) {
...
{name:'showTitle',type:'boolean',description:'',refreshable:true},
{name:'sizeMin',type:'number',description:''},
{name:'sizeShare',type:'number',description:''},
{name:'splitter',type:'boolean',description:''},
{name:'style',type:'string',description:'',refreshable:true},
{name:'title',type:'string',description:'',refreshable:true},
{name:'tooltip',type:'string',description:'',refreshable:true},				]
};
break;
...
{name:'dir',type:'string',description:''},
{name:'disabled',type:'boolean',description:'',refreshable:true},
{name:'iconClass',type:'string',description:''},
{name:'inputType',type:'string',description:'Corresponds to the type attribute of the Button object.'},
{name:'intermediateChanges',type:'boolean',description:'',refreshable:true},
{name:'key',type:'string',description:'Key that identifies this layout object. The name of a key cannot include a colon (:).'},
{name:'label',type:'string',description:'',refreshable:true},
{name:'lang',type:'string',description:''},
...
{name:'title',type:'string',description:'',refreshable:true},
{name:'tooltip',type:'string',description:'',refreshable:true},
{name:'value',type:'string',description:'',refreshable:true},
{name:'$ignoreChange',type:'boolean',description:'If true, suppress default generation of onchange handlers (if any).'},
{name:'$ignoreSelect',type:'boolean',description:'If true, suppress default generation of select handlers (if any).'},				]
};
break;
case '$CheckBox':
documentation = {
...
{name:'alt',type:'string',description:''},
{name:'baseClass',type:'string',description:''},
{name:'checked',type:'boolean',description:'',refreshable:true},
{name:'cssStateNodes',type:'object',description:''},
{name:'dir',type:'string',description:''},
{name:'disabled',type:'boolean',description:'',refreshable:true},
{name:'iconClass',type:'string',description:''},
...
{name:'lang',type:'string',description:''},
{name:'name',type:'string',description:''},
{name:'readOnly',type:'boolean',description:'',refreshable:true},
{name:'renderInline',type:'boolean',description:''},
{name:'scrollOnFocus',type:'boolean',description:''},
{name:'showLabel',type:'boolean',description:''},
{name:'style',type:'string',description:'',refreshable:true},
...
attributes:[
{name:'alt',type:'string',description:''},
{name:'autoComplete',type:'boolean',description:'',refreshable:true},
{name:'autoWidth',type:'boolean',description:'',refreshable:true},
{name:'baseClass',type:'string',description:''},
{name:'constraints',type:'object',description:'',refreshable:true},
{name:'cssStateNodes',type:'object',description:''},
{name:'dir',type:'string',description:''},
{name:'disabled',type:'boolean',description:'',refreshable:true},
{name:'dropDownPosition',type:'object',description:''},
{name:'fetchProperties',type:'object',description:''},
{name:'forceWidth',type:'boolean',description:'',refreshable:true},
{name:'hasDownArrow',type:'boolean',description:'',refreshable:true},
{name:'highlightMatch',type:'string',description:''},
{name:'ignoreCase',type:'boolean',description:'',refreshable:true},
{name:'intermediateChanges',type:'boolean',description:'',refreshable:true},
...
{name:'maxLength',type:'string',description:'',refreshable:true},
{name:'message',type:'string',description:'',refreshable:true},
{name:'missingMessage',type:'string',description:'',refreshable:true},
{name:'name',type:'string',description:''},
{name:'pageSize',type:'number',description:'',refreshable:true},
{name:'pattern',type:'string',description:'',refreshable:true},
{name:'placeHolder',type:'string',description:'',refreshable:true},
{name:'promptMessage',type:'string',description:'',refreshable:true},
{name:'propercase',type:'boolean',description:'',refreshable:true},
{name:'query',type:'object',description:''},
{name:'queryExpression',type:'string',description:''},
{name:'readOnly',type:'boolean',description:'',refreshable:true},
{name:'regExp',type:'string',description:'',refreshable:true},
{name:'renderInline',type:'boolean',description:''},
{name:'required',type:'boolean',description:''},
{name:'scrollOnFocus',type:'boolean',description:''},
{name:'searchAttr',type:'string',description:'',refreshable:true},
{name:'searchDelay',type:'number',description:'',refreshable:true},
{name:'selectOnClick',type:'boolean',description:'',refreshable:true},
...
{name:'trim',type:'boolean',description:'',refreshable:true},
{name:'uppercase',type:'boolean',description:'',refreshable:true},
{name:'value',type:'string',description:'',refreshable:true},
{name:'$ignoreChange',type:'boolean',description:'If true, suppress default generation of onchange handlers (if any).'},
{name:'$ignoreSelect',type:'boolean',description:'If true, suppress default generation of select handlers (if any).'},				]
};
...
{name:'maxHeight',type:'number',description:''},
{name:'name',type:'string',description:''},
{name:'optionsTitle',type:'string',description:'',refreshable:true},
{name:'renderInline',type:'boolean',description:''},
{name:'scrollOnFocus',type:'boolean',description:''},
{name:'showLabel',type:'boolean',description:''},
{name:'style',type:'string',description:'',refreshable:true},
...
{name:'lang',type:'string',description:''},
{name:'layoutPriority',type:'string',description:''},
{name:'loadingMessage',type:'string',description:'',refreshable:true},
{name:'maxSize',type:'number',description:''},
{name:'minSize',type:'number',description:''},
...
{name:'region',type:'string',description:''},
{name:'renderInline',type:'boolean',description:''},
{name:'selected',type:'boolean',description:'',refreshable:true},
{name:'showTitle',type:'boolean',description:'',refreshable:true},
{name:'sizeMin',type:'number',description:''},
{name:'sizeShare',type:'number',description:''},
{name:'splitter',type:'boolean',description:''},
...
{name:'constraints',type:'object',description:'',refreshable:true},
{name:'cssStateNodes',type:'object',description:''},
{name:'currency',type:'string',description:'',refreshable:true},
{name:'dir',type:'string',description:''},
{name:'disabled',type:'boolean',description:'',refreshable:true},
...
{name:'intermediateChanges',type:'boolean',description:'',refreshable:true},
{name:'invalidMessage',type:'string',description:'',refreshable:true},
{name:'key',type:'string',description:'Key that identifies this layout object. The name of a key cannot include a colon (:).'},
{name:'label',type:'string',description:'',refreshable:true},
{name:'lang',type:'string',description:''},
{name:'lowercase',type:'boolean',description:'',refreshable:true},
...
{name:'placeHolder',type:'string',description:'',refreshable:true},
{name:'propercase',type:'boolean',description:'',refreshable:true},
{name:'rangeMessage',type:'string',description:'',refreshable:true},
{name:'regExp',type:'string',description:'',refreshable:true},
{name:'renderInline',type:'boolean',description:''},
{name:'required',type:'boolean',description:''},
{name:'scrollOnFocus',type:'boolean',description:''},
...
{name:'title',type:'string',description:'',refreshable:true},
{name:'tooltip',type:'string',description:'',refreshable:true},
{name:'valueList',type:'string',description:'',refreshable:true},				]
};
break;
case '$DateTextBox':
documentation = {
...
{name:'baseClass',type:'string',description:''},
{name:'children',type:'array',description:'Child layout objects to contain within this widget. These can be layout objects defined by the same plugin (most common), layout objects defined by other plugins, or a mix.'},
{name:'closable',type:'boolean',description:'',refreshable:false},
{name:'content',type:'string',description:'',refreshable:true},
{name:'dir',type:'string',description:''},
{name:'disabled',type:'boolean',description:'',refreshable:false},
{name:'doLayout',type:'boolean',description:''},
{name:'draggable',type:'boolean',description:'',refreshable:false},
{name:'duration',type:'number',description:'',refreshable:true},
{name:'errorMessage',type:'string',description:'',refreshable:true},
{name:'extractContent',type:'boolean',description:''},
{name:'href',type:'string',description:''},
{name:'iconClass',type:'string',description:''},
{name:'ioArgs',type:'object',description:''},
...
{name:'preload',type:'boolean',description:''},
{name:'preventCache',type:'boolean',description:''},
{name:'refocus',type:'boolean',description:'',refreshable:true},
{name:'refreshOnShow',type:'boolean',description:''},
{name:'region',type:'string',description:''},
{name:'renderInline',type:'boolean',description:''},
{name:'selected',type:'boolean',description:'',refreshable:true},
...
{name:'closable',type:'boolean',description:'',refreshable:true},
{name:'content',type:'string',description:'',refreshable:true},
{name:'dir',type:'string',description:''},
{name:'disabled',type:'boolean',description:'',refreshable:true},
{name:'doLayout',type:'boolean',description:''},
...
attributes:[
{name:'alt',type:'string',description:'',refreshable:true},
{name:'autoWidth',type:'boolean',description:'',refreshable:true},
{name:'baseClass',type:'string',description:''},
{name:'children',type:'array',description:'Child layout objects to contain within this widget. These can be layout objects defined by the same plugin (most common), layout objects defined by other plugins, or a mix.'},
{name:'cssStateNodes',type:'object',description:''},
...
{name:'label',type:'string',description:'',refreshable:true},
{name:'lang',type:'string',description:''},
{name:'maxHeight',type:'number',description:'',refreshable:true},
{name:'name',type:'string',description:''},
{name:'renderInline',type:'boolean',description:''},
{name:'scrollOnFocus',type:'boolean',description:''},
{name:'showLabel',type:'boolean',description:'',refreshable:true},
{name:'style',type:'string',description:'',refreshable:true},
{name:'tabIndex',type:'string',description:''},
{name:'title',type:'string',description:'',refreshable:true},
{name:'tooltip',type:'string',description:'',refreshable:true},
...
attributes:[
{name:'autofocus',type:'boolean',description:'',refreshable:true},
{name:'baseClass',type:'string',description:''},
{name:'children',type:'array',description:'Child layout objects to contain within this widget. These can be layout objects defined by the same plugin (most common), layout objects defined by other plugins, or a mix.'},
{name:'cssStateNodes',type:'object',description:''},
{name:'dir',type:'string',description:''},
{name:'key',type:'string',description:'Key that identifies this layout object. The name of a key cannot include a colon (:).'},
{name:'lang',type:'string',description:''},
{name:'multiCharSearchDuration',type:'number',description:'',refreshable:true},
{name:'passivePopupDelay',type:'number',description:'',refreshable:true},
{name:'popupDelay',type:'number',description:'',refreshable:true},
{name:'renderInline',type:'boolean',description:''},
{name:'selected',type:'boolean',description:'',refreshable:true},
{name:'style',type:'string',description:'',refreshable:true},
{name:'tabIndex',type:'string',description:''},
...
{name:'height',type:'string',description:'',refreshable:true},
...
{name:'title',type:'string',description:'',refreshable:true},
{name:'tooltip',type:'string',description:'',refreshable:true},
{name:'updateInterval',type:'number',description:'',refreshable:true},
{name:'value',type:'string',description:'',refreshable:true},
{name:'$ignoreChange',type:'boolean',description:'If true, suppress default generation of onchange handlers (if any).'},
{name:'$ignoreSelect',type:'boolean',description:'If true, suppress default generation of select handlers (if any).'},				]
};
...
{name:'maxSize',type:'number',description:''},
{name:'minSize',type:'number',description:''},
{name:'open',type:'boolean',description:'',refreshable:true},
{name:'parseOnLoad',type:'boolean',description:''},
{name:'parserScope',type:'string',description:''},
{name:'preload',type:'boolean',description:''},
{name:'preventCache',type:'boolean',description:''},
...
{name:'selected',type:'boolean',description:'',refreshable:true},
{name:'showTitle',type:'boolean',description:'',refreshable:true},
{name:'sizeMin',type:'number',description:'',refreshable:true},
{name:'sizeShare',type:'number',description:'',refreshable:true},
{name:'splitter',type:'boolean',description:''},
{name:'stopParser',type:'boolean',description:''},
{name:'style',type:'string',description:'',refreshable:true},
{name:'tabIndex',type:'string',description:''},
{name:'title',type:'string',description:'',refreshable:true},
{name:'toggleable',type:'boolean',description:'',refreshable:true},
{name:'tooltip',type:'string',description:'',refreshable:true},				]
};
break;
...
{name:'forceWidth',type:'boolean',description:'',refreshable:true},
{name:'hasDownArrow',type:'boolean',description:'',refreshable:true},
{name:'highlightMatch',type:'string',description:'',refreshable:true},
{name:'ignoreCase',type:'boolean',description:'',refreshable:true},
{name:'intermediateChanges',type:'boolean',description:'',refreshable:true},
{name:'invalidMessage',type:'string',description:'',refreshable:true},
{name:'key',type:'string',description:'Key that identifies this layout object. The name of a key cannot include a colon (:).'},
...
{name:'count',type:'number',description:'',refreshable:true},
{name:'dir',type:'string',description:''},
{name:'disabled',type:'boolean',description:'',refreshable:true},
{name:'intermediateChanges',type:'boolean',description:'',refreshable:true},
{name:'key',type:'string',description:'Key that identifies this layout object. The name of a key cannot include a colon (:).'},
...
{name:'name',type:'string',description:''},
{name:'renderInline',type:'boolean',description:''},
{name:'ruleStyle',type:'string',description:'',refreshable:true},
{name:'scrollOnFocus',type:'boolean',description:''},
{name:'style',type:'string',description:'',refreshable:true},
{name:'tabIndex',type:'string',description:''},
{name:'title',type:'string',description:'',refreshable:true},
...
{name:'labelStyle',type:'string',description:'',refreshable:true},
{name:'lang',type:'string',description:''},
{name:'maximum',type:'number',description:'',refreshable:true},
{name:'minimum',type:'number',description:'',refreshable:true},
{name:'name',type:'string',description:''},
{name:'numericMargin',type:'number',description:'',refreshable:true},
{name:'renderInline',type:'boolean',description:''},
{name:'ruleStyle',type:'string',description:'',refreshable:true},
{name:'scrollOnFocus',type:'boolean',description:''},
{name:'style',type:'string',description:'',refreshable:true},
...
{name:'baseClass',type:'string',description:''},
{name:'children',type:'array',description:'Child layout objects to contain within this widget. These can be layout objects defined by the same plugin (most common), layout objects defined by other plugins, or a mix.'},
{name:'clickSelect',type:'boolean',description:'',refreshable:true},
{name:'cssStateNodes',type:'object',description:''},
{name:'dir',type:'string',description:''},
{name:'disabled',type:'boolean',description:'',refreshable:true},
{name:'discreteValues',type:'number',description:'',refreshable:true},
{name:'intermediateChanges',type:'boolean',description:'',refreshable:true},
{name:'key',type:'string',description:'Key that identifies this layout object. The name of a key cannot include a colon (:).'},
{name:'label',type:'string',description:'',refreshable:true},
{name:'lang',type:'string',description:''},
...
{name:'minimum',type:'number',description:'',refreshable:true},
{name:'name',type:'string',description:''},
{name:'pageIncrement',type:'number',description:'',refreshable:true},
{name:'readOnly',type:'boolean',description:'',refreshable:true},
{name:'renderInline',type:'boolean',description:''},
{name:'scrollOnFocus',type:'boolean',description:''},
{name:'showButtons',type:'boolean',description:'',refreshable:true},
{name:'slideDuration',type:'number',description:'',refreshable:true},
{name:'style',type:'string',description:'',refreshable:true},
{name:'tabIndex',type:'string',description:''},
{name:'title',type:'string',description:'',refreshable:true},
{name:'tooltip',type:'string',description:'',refreshable:true},
...
attributes:[
{name:'autoSave',type:'boolean',description:'',refreshable:true},
{name:'baseClass',type:'string',description:''},
{name:'buttonCancel',type:'string',description:'',refreshable:true},
{name:'buttonSave',type:'string',description:'',refreshable:true},
{name:'dir',type:'string',description:''},
{name:'disabled',type:'boolean',description:'',refreshable:true},
...
{name:'key',type:'string',description:'Key that identifies this layout object. The name of a key cannot include a colon (:).'},
{name:'lang',type:'string',description:''},
{name:'noValueIndicator',type:'string',description:'',refreshable:true},
...
{name:'tooltip',type:'string',description:'',refreshable:true},
{name:'value',type:'string',description:'',refreshable:true},
{name:'width',type:'string',description:'',refreshable:true},
{name:'$ignoreChange',type:'boolean',description:'If true, suppress default generation of onchange handlers (if any).'},
{name:'$ignoreSelect',type:'boolean',description:'If true, suppress default generation of select handlers (if any).'},				]
};
break;
...
{name:'key',type:'string',description:'Key that identifies this layout object. The name of a key cannot include a colon (:).'},
{name:'lang',type:'string',description:''},
{name:'leftClickToOpen',type:'boolean',description:'',refreshable:true},
{name:'multiCharSearchDuration',type:'number',description:'',refreshable:true},
{name:'passivePopupDelay',type:'number',description:'',refreshable:true},
{name:'popupDelay',type:'number',description:'',refreshable:true},
{name:'refocus',type:'boolean',description:'',refreshable:true},
...
{name:'renderInline',type:'boolean',description:''},
{name:'scrollOnFocus',type:'boolean',description:''},
{name:'size',type:'number',description:'',refreshable:true},
{name:'style',type:'string',description:'',refreshable:true},
{name:'tabIndex',type:'string',description:''},
{name:'title',type:'string',description:'',refreshable:true},
{name:'tooltip',type:'string',description:'',refreshable:true},
...
{name:'constraints',type:'object',description:'',refreshable:true},
{name:'cssStateNodes',type:'object',description:''},
{name:'defaultTimeout',type:'number',description:'',refreshable:true},
{name:'dir',type:'string',description:''},
{name:'disabled',type:'boolean',description:'',refreshable:true},
{name:'editOptions',type:'object',description:''},
...
{name:'label',type:'string',description:'',refreshable:true},
{name:'lang',type:'string',description:''},
{name:'largeDelta',type:'number',description:'',refreshable:true},
{name:'lowercase',type:'boolean',description:'',refreshable:true},
{name:'maxLength',type:'string',description:'',refreshable:true},
{name:'message',type:'string',description:'',refreshable:true},
{name:'minimumTimeout',type:'number',description:'',refreshable:true},
{name:'missingMessage',type:'string',description:'',refreshable:true},
{name:'name',type:'string',description:''},
{name:'pattern',type:'string',description:'',refreshable:true},
{name:'placeHolder',type:'string',description:'',refreshable:true},
...
{name:'scrollOnFocus',type:'boolean',description:''},
{name:'selectOnClick',type:'boolean',description:''},
{name:'smallDelta',type:'number',description:'',refreshable:true},
{name:'style',type:'string',description:'',refreshable:true},
{name:'tabIndex',type:'string',description:''},
{name:'timeoutChangeRate',type:'number',description:'',refreshable:true},
{name:'title',type:'string',description:'',refreshable:true},
{name:'tooltip',type:'string',description:'',refreshable:true},
{name:'tooltipPosition',type:'object',description:''},
{name:'trim',type:'boolean',description:'',refreshable:true},
...
{name:'baseClass',type:'string',description:''},
{name:'dir',type:'string',description:''},
{name:'indeterminate',type:'boolean',description:'',refreshable:true},
{name:'key',type:'string',description:'Key that identifies this layout object. The name of a key cannot include a colon (:).'},
{name:'label',type:'string',description:'',refreshable:true},
{name:'lang',type:'string',description:''},
{name:'maximum',type:'number',description:'',refreshable:true},
{name:'places',type:'number',description:'',refreshable:true},
{name:'progress',type:'string',description:'',refreshable:true},
{name:'renderInline',type:'boolean',description:''},
{name:'style',type:'string',description:'',refreshable:true},
{name:'title',type:'string',description:'',refreshable:true},
{name:'tooltip',type:'string',description:'',refreshable:true},
...
{name:'baseClass',type:'string',description:''},
{name:'checked',type:'boolean',description:'',refreshable:true},
{name:'checkedChar',type:'string',description:'',refreshable:true},
{name:'cssStateNodes',type:'object',description:''},
{name:'dir',type:'string',description:''},
{name:'disabled',type:'boolean',description:'',refreshable:true},
...
{name:'disabled',type:'boolean',description:'',refreshable:true},
{name:'dropDownPosition',type:'object',description:''},
{name:'emptyLabel',type:'string',description:'',refreshable:true},
{name:'forceWidth',type:'boolean',description:'',refreshable:true},
{name:'intermediateChanges',type:'boolean',description:'',refreshable:true},
{name:'key',type:'string',description:'Key that identifies this layout object. The name of a key cannot include a colon (:).'},
{name:'label',type:'string',description:'',refreshable:true},
...
{name:'alt',type:'string',description:'',refreshable:true},
{name:'baseClass',type:'string',description:''},
{name:'cols',type:'string',description:'',refreshable:true},
{name:'cssStateNodes',type:'object',description:''},
{name:'dir',type:'string',description:''},
{name:'disabled',type:'boolean',description:'',refreshable:true},
{name:'intermediateChanges',type:'boolean',description:'',refreshable:true},
...
{name:'readOnly',type:'boolean',description:'',refreshable:true},
{name:'renderInline',type:'boolean',description:''},
{name:'rows',type:'number',description:'',refreshable:true},
{name:'scrollOnFocus',type:'boolean',description:''},
{name:'selectOnClick',type:'boolean',description:''},
{name:'style',type:'string',description:'',refreshable:true},
{name:'tabIndex',type:'string',description:''},
...
{name:'lang',type:'string',description:''},
{name:'layoutPriority',type:'string',description:''},
{name:'maxSize',type:'number',description:'',refreshable:true},
{name:'minSize',type:'number',description:'',refreshable:true},
...
{name:'showTitle',type:'boolean',description:'',refreshable:true},
{name:'sizeMin',type:'number',description:'',refreshable:true},
{name:'sizerWidth',type:'number',description:'',refreshable:true},
{name:'sizeShare',type:'number',description:''},
{name:'splitter',type:'boolean',description:''},
{name:'style',type:'string',description:'',refreshable:true},
{name:'title',type:'string',description:'',refreshable:true},
...
attributes:[
{name:'baseClass',type:'string',description:''},
{name:'data',type:'object',description:'',refreshable:true},
{name:'dir',type:'string',description:''},
...
{name:'splitter',type:'boolean',description:''},
{name:'style',type:'string',description:'',refreshable:true},
{name:'tabPosition',type:'string',description:'',refreshable:true},
{name:'tabStrip',type:'boolean',description:'',refreshable:true},
{name:'templateString',type:'string',description:''},
{name:'title',type:'string',description:'',refreshable:true},
{name:'tooltip',type:'string',description:'',refreshable:true},
{name:'useMenu',type:'boolean',description:'',refreshable:true},
{name:'useSlider',type:'boolean',description:'',refreshable:true},				]
};
break;
case '$Textarea':
documentation = {
...
{name:'constraints',type:'object',description:'',refreshable:true},
{name:'cssStateNodes',type:'object',description:''},
{name:'datePackage',type:'string',description:'',refreshable:true},
{name:'dir',type:'string',description:''},
{name:'disabled',type:'boolean',description:'',refreshable:true},
{name:'dropDownDefaultValue',type:'string',description:'',refreshable:true},
{name:'dropDownPosition',type:'object',description:''},
{name:'forceWidth',type:'boolean',description:'',refreshable:true},
{name:'hasDownArrow',type:'boolean',description:'',refreshable:true},
{name:'inputType',type:'string',description:'Corresponds to the type option.'},
...
{name:'renderInline',type:'boolean',description:''},
{name:'selector',type:'object',description:''},
{name:'showDelay',type:'number',description:'',refreshable:true},
{name:'style',type:'string',description:'',refreshable:true},
{name:'title',type:'string',description:'',refreshable:true},
{name:'tooltip',type:'string',description:'',refreshable:true},				]
};
...
self._ZEN_Mojo_Plugin_dojo191DijitHelperDocumentation__Loader = function() {
	zenLoadClass('_ZEN_Mojo_Plugin_baseHelperDocumentation');
	_ZEN_Mojo_Plugin_dojo191DijitHelperDocumentation.prototype = zenCreate('_ZEN_Mojo_Plugin_baseHelperDocumentation',-1);
	var p = _ZEN_Mojo_Plugin_dojo191DijitHelperDocumentation.prototype;
	if (null==p) {return;}
	p.constructor = _ZEN_Mojo_Plugin_dojo191DijitHelperDocumentation;
	...
	p._serverClass = '%ZEN.Mojo.Plugin.dojo191DijitHelperDocumentation';
	p._type = 'dojo191DijitHelperDocumentation';
	p.serialize = _ZEN_Mojo_Plugin_dojo191DijitHelperDocumentation_serialize;
	p.getSettings = _ZEN_Mojo_Plugin_dojo191DijitHelperDocumentation_getSettings;
	p.getDocumentation = _ZEN_Mojo_Plugin_dojo191DijitHelperDocumentation_getDocumentation;
}
/* EOF */