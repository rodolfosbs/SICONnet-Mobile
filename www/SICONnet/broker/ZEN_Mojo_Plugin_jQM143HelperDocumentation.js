/*** Zen Module: ZEN_Mojo_Plugin_jQM143HelperDocumentation ***/

self._zenClassIdx['http://www.intersystems.com/zen/mojo/jQM143HelperDocumentation'] = '_ZEN_Mojo_Plugin_jQM143HelperDocumentation';
self._ZEN_Mojo_Plugin_jQM143HelperDocumentation = function(index,id) {
	if (index>=0) {_ZEN_Mojo_Plugin_jQM143HelperDocumentation__init(this,index,id);}
}

self._ZEN_Mojo_Plugin_jQM143HelperDocumentation__init = function(o,index,id) {
...
function _ZEN_Mojo_Plugin_jQM143HelperDocumentation_serialize(set,s)
{
...
function _ZEN_Mojo_Plugin_jQM143HelperDocumentation_getSettings(s)
{
	s['name'] = 'string';
	this.invokeSuper('getSettings',arguments);
}

self._ZEN_Mojo_Plugin_jQM143HelperDocumentation_getDocumentation = function(identifier) {
...
self._ZEN_Mojo_Plugin_jQM143HelperDocumentation__Loader = function() {
	zenLoadClass('_ZEN_Mojo_Plugin_baseHelperDocumentation');
	_ZEN_Mojo_Plugin_jQM143HelperDocumentation.prototype = zenCreate('_ZEN_Mojo_Plugin_baseHelperDocumentation',-1);
	var p = _ZEN_Mojo_Plugin_jQM143HelperDocumentation.prototype;
	if (null==p) {return;}
	p.constructor = _ZEN_Mojo_Plugin_jQM143HelperDocumentation;
	...
	p._serverClass = '%ZEN.Mojo.Plugin.jQM143HelperDocumentation';
	p._type = 'jQM143HelperDocumentation';
	p.serialize = _ZEN_Mojo_Plugin_jQM143HelperDocumentation_serialize;
	p.getSettings = _ZEN_Mojo_Plugin_jQM143HelperDocumentation_getSettings;
	p.getDocumentation = _ZEN_Mojo_Plugin_jQM143HelperDocumentation_getDocumentation;
}
/* EOF */