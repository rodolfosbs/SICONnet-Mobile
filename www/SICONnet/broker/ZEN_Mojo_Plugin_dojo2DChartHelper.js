/*** Zen Module: ZEN_Mojo_Plugin_dojo2DChartHelper ***/

self._zenClassIdx['http://www.intersystems.com/zen/mojo/dojo2DChartHelper'] = '_ZEN_Mojo_Plugin_dojo2DChartHelper';
self._ZEN_Mojo_Plugin_dojo2DChartHelper = function(index,id) {
	if (index>=0) {_ZEN_Mojo_Plugin_dojo2DChartHelper__init(this,index,id);}
}

self._ZEN_Mojo_Plugin_dojo2DChartHelper__init = function(o,index,id) {
	...
	o.pluginName = 'dojo2DChartHelper';
	o.version = '1.0.3';
}
function _ZEN_Mojo_Plugin_dojo2DChartHelper_serialize(set,s)
{
...
function _ZEN_Mojo_Plugin_dojo2DChartHelper_getSettings(s)
{
	s['name'] = 'string';
	s['pluginName'] = 'string';
	s['version'] = 'string';
...
self._ZEN_Mojo_Plugin_dojo2DChartHelper_createLayoutObjects = function(type,instance) {
...
self._ZEN_Mojo_Plugin_dojo2DChartHelper_getDojoTypes = function() {
...
self._ZEN_Mojo_Plugin_dojo2DChartHelper_getFeatures = function() {
return [
{identifier:'$Chart'},
...
self._ZEN_Mojo_Plugin_dojo2DChartHelper_linkDojoItem = function() {
var registry = require("dijit/registry");
var item = registry.byId(this.$makeId('dojo'));
this.$dojoItem = item;
}

self._ZEN_Mojo_Plugin_dojo2DChartHelper_onCheckLibraries = function() {
...
self._ZEN_Mojo_Plugin_dojo2DChartHelper_registerDojoType = function(instance) {
...
self._ZEN_Mojo_Plugin_dojo2DChartHelper_registerDojoTypeByType = function(type) {
...
self._ZEN_Mojo_Plugin_dojo2DChartHelper_renderChart = function() {
var html = [];
var props = [];
var attributes = [];
var documentView = this.$documentView;
...
self._ZEN_Mojo_Plugin_dojo2DChartHelper_renderChartLegend = function() {
var html = [];
var props = [];
var attributes = [];
var documentView = this.$documentView;
...
self._ZEN_Mojo_Plugin_dojo2DChartHelper_setupChart = function() {
var instance = this;
var requiredModules = [];
...
var chart = new Chart(instance.$makeId('dojo'),zenGet(instance.title,null));
...
self._ZEN_Mojo_Plugin_dojo2DChartHelper__Loader = function() {
	zenLoadClass('_ZEN_Mojo_Plugin_baseHelperPlugin');
	_ZEN_Mojo_Plugin_dojo2DChartHelper.prototype = zenCreate('_ZEN_Mojo_Plugin_baseHelperPlugin',-1);
	var p = _ZEN_Mojo_Plugin_dojo2DChartHelper.prototype;
	if (null==p) {return;}
	p.constructor = _ZEN_Mojo_Plugin_dojo2DChartHelper;
	...
	p._serverClass = '%ZEN.Mojo.Plugin.dojo2DChartHelper';
	p._type = 'dojo2DChartHelper';
	p.serialize = _ZEN_Mojo_Plugin_dojo2DChartHelper_serialize;
	p.getSettings = _ZEN_Mojo_Plugin_dojo2DChartHelper_getSettings;
	p.createLayoutObjects = _ZEN_Mojo_Plugin_dojo2DChartHelper_createLayoutObjects;
	p.getDojoTypes = _ZEN_Mojo_Plugin_dojo2DChartHelper_getDojoTypes;
	p.getFeatures = _ZEN_Mojo_Plugin_dojo2DChartHelper_getFeatures;
	p.linkDojoItem = _ZEN_Mojo_Plugin_dojo2DChartHelper_linkDojoItem;
	p.onCheckLibraries = _ZEN_Mojo_Plugin_dojo2DChartHelper_onCheckLibraries;
	p.registerDojoType = _ZEN_Mojo_Plugin_dojo2DChartHelper_registerDojoType;
	p.registerDojoTypeByType = _ZEN_Mojo_Plugin_dojo2DChartHelper_registerDojoTypeByType;
	p.renderChart = _ZEN_Mojo_Plugin_dojo2DChartHelper_renderChart;
	p.renderChartLegend = _ZEN_Mojo_Plugin_dojo2DChartHelper_renderChartLegend;
	p.setupChart = _ZEN_Mojo_Plugin_dojo2DChartHelper_setupChart;
}
/* EOF */