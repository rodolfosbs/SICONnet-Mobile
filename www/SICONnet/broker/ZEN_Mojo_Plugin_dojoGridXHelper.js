/*** Zen Module: ZEN_Mojo_Plugin_dojoGridXHelper ***/

self._zenClassIdx['http://www.intersystems.com/zen/mojo/dojoGridXHelper'] = '_ZEN_Mojo_Plugin_dojoGridXHelper';
self._ZEN_Mojo_Plugin_dojoGridXHelper = function(index,id) {
	if (index>=0) {_ZEN_Mojo_Plugin_dojoGridXHelper__init(this,index,id);}
}

self._ZEN_Mojo_Plugin_dojoGridXHelper__init = function(o,index,id) {
	...
	o.pluginName = 'dojoGridXHelper';
	o.version = '1.0.3';
}
function _ZEN_Mojo_Plugin_dojoGridXHelper_serialize(set,s)
{
...
function _ZEN_Mojo_Plugin_dojoGridXHelper_getSettings(s)
{
	s['name'] = 'string';
	s['pluginName'] = 'string';
	s['version'] = 'string';
...
self._ZEN_Mojo_Plugin_dojoGridXHelper_clone = function(obj) {
...
self._ZEN_Mojo_Plugin_dojoGridXHelper_createLayoutObjects = function(type,instance) {
...
self._ZEN_Mojo_Plugin_dojoGridXHelper_getDojoTypes = function() {
...
self._ZEN_Mojo_Plugin_dojoGridXHelper_getFeatures = function() {
return [
{identifier:'$Gridx'}
];
}

self._ZEN_Mojo_Plugin_dojoGridXHelper_linkDojoItem = function() {
var registry = require("dijit/registry");
var item = registry.byId(this.$makeId('dojo'));
this.$dojoItem = item;
}

self._ZEN_Mojo_Plugin_dojoGridXHelper_onCheckLibraries = function() {
...
self._ZEN_Mojo_Plugin_dojoGridXHelper_registerDojoType = function(instance) {
...
self._ZEN_Mojo_Plugin_dojoGridXHelper_registerDojoTypeByType = function(type) {
...
self._ZEN_Mojo_Plugin_dojoGridXHelper_renderGridx = function() {
var html = [];
var props = [];
var attributes = [];
var documentView = this.$documentView;
...
self._ZEN_Mojo_Plugin_dojoGridXHelper_setupGridx = function() {
var instance = this;
var requiredModules = [];
...
self._ZEN_Mojo_Plugin_dojoGridXHelper__Loader = function() {
	zenLoadClass('_ZEN_Mojo_Plugin_baseHelperPlugin');
	_ZEN_Mojo_Plugin_dojoGridXHelper.prototype = zenCreate('_ZEN_Mojo_Plugin_baseHelperPlugin',-1);
	var p = _ZEN_Mojo_Plugin_dojoGridXHelper.prototype;
	if (null==p) {return;}
	p.constructor = _ZEN_Mojo_Plugin_dojoGridXHelper;
	...
	p._serverClass = '%ZEN.Mojo.Plugin.dojoGridXHelper';
	p._type = 'dojoGridXHelper';
	p.serialize = _ZEN_Mojo_Plugin_dojoGridXHelper_serialize;
	p.getSettings = _ZEN_Mojo_Plugin_dojoGridXHelper_getSettings;
	p.clone = _ZEN_Mojo_Plugin_dojoGridXHelper_clone;
	p.createLayoutObjects = _ZEN_Mojo_Plugin_dojoGridXHelper_createLayoutObjects;
	p.getDojoTypes = _ZEN_Mojo_Plugin_dojoGridXHelper_getDojoTypes;
	p.getFeatures = _ZEN_Mojo_Plugin_dojoGridXHelper_getFeatures;
	p.linkDojoItem = _ZEN_Mojo_Plugin_dojoGridXHelper_linkDojoItem;
	p.onCheckLibraries = _ZEN_Mojo_Plugin_dojoGridXHelper_onCheckLibraries;
	p.registerDojoType = _ZEN_Mojo_Plugin_dojoGridXHelper_registerDojoType;
	p.registerDojoTypeByType = _ZEN_Mojo_Plugin_dojoGridXHelper_registerDojoTypeByType;
	p.renderGridx = _ZEN_Mojo_Plugin_dojoGridXHelper_renderGridx;
	p.setupGridx = _ZEN_Mojo_Plugin_dojoGridXHelper_setupGridx;
}
/* EOF */