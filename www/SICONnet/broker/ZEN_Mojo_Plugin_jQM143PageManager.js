/*** Zen Module: ZEN_Mojo_Plugin_jQM143PageManager ***/

self._zenClassIdx['http://www.intersystems.com/zen/mojo/jQM-1.4.3-PageManager'] = '_ZEN_Mojo_Plugin_jQM143PageManager';
self._ZEN_Mojo_Plugin_jQM143PageManager = function(index,id) {
	if (index>=0) {_ZEN_Mojo_Plugin_jQM143PageManager__init(this,index,id);}
}

self._ZEN_Mojo_Plugin_jQM143PageManager__init = function(o,index,id) {
	...
	o.jQueryTheme = 'a';
	o.onPageShow = '';
	o.pluginName = 'jQM-1.4.3-PageManager';
	o.suppressRender = true;
	o.suppressStopPropagation = true;
	o.version = '1.0.4';
}
function _ZEN_Mojo_Plugin_jQM143PageManager_serialize(set,s)
{
...
function _ZEN_Mojo_Plugin_jQM143PageManager_getSettings(s)
{
	s['name'] = 'string';
...
self._ZEN_Mojo_Plugin_jQM143PageManager_afterPopDocument = function(docView,render) {
...
self._ZEN_Mojo_Plugin_jQM143PageManager_afterRenderDocument = function(docView,displayMode,html) {
...
self._ZEN_Mojo_Plugin_jQM143PageManager_getDocumentAttributes = function(docView,displayMode) {
var pageId = 'page'+displayMode+docView.currLevel;
return 'data-role="page" data-url="'+pageId+'" parentindex="'+docView.index+'" data-theme="'+this.jQueryTheme+'" id="'+pageId+'"';
}

self._ZEN_Mojo_Plugin_jQM143PageManager_onCheckLibraries = function() {
if (typeof $ === 'undefined') {
...
self._ZEN_Mojo_Plugin_jQM143PageManager__Loader = function() {
	zenLoadClass('_ZEN_Mojo_Plugin_basePageManager');
	_ZEN_Mojo_Plugin_jQM143PageManager.prototype = zenCreate('_ZEN_Mojo_Plugin_basePageManager',-1);
	var p = _ZEN_Mojo_Plugin_jQM143PageManager.prototype;
	if (null==p) {return;}
	p.constructor = _ZEN_Mojo_Plugin_jQM143PageManager;
	...
	p._serverClass = '%ZEN.Mojo.Plugin.jQM143PageManager';
	p._type = 'jQM143PageManager';
	p.serialize = _ZEN_Mojo_Plugin_jQM143PageManager_serialize;
	p.getSettings = _ZEN_Mojo_Plugin_jQM143PageManager_getSettings;
	p.afterPopDocument = _ZEN_Mojo_Plugin_jQM143PageManager_afterPopDocument;
	p.afterRenderDocument = _ZEN_Mojo_Plugin_jQM143PageManager_afterRenderDocument;
	p.getDocumentAttributes = _ZEN_Mojo_Plugin_jQM143PageManager_getDocumentAttributes;
	p.onCheckLibraries = _ZEN_Mojo_Plugin_jQM143PageManager_onCheckLibraries;
}
/* EOF */