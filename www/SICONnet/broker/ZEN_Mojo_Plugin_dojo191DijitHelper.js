/*** Zen Module: ZEN_Mojo_Plugin_dojo191DijitHelper ***/

self._zenClassIdx['http://www.intersystems.com/zen/mojo/dojo-1.9.1-DijitHelper'] = '_ZEN_Mojo_Plugin_dojo191DijitHelper';
self._ZEN_Mojo_Plugin_dojo191DijitHelper = function(index,id) {
	if (index>=0) {_ZEN_Mojo_Plugin_dojo191DijitHelper__init(this,index,id);}
}

self._ZEN_Mojo_Plugin_dojo191DijitHelper__init = function(o,index,id) {
	...
	o.pluginName = 'dojo-1.9.1-DijitHelper';
	o.version = '1.0.10';
}
function _ZEN_Mojo_Plugin_dojo191DijitHelper_serialize(set,s)
{
...
function _ZEN_Mojo_Plugin_dojo191DijitHelper_getSettings(s)
{
	s['name'] = 'string';
	s['pluginName'] = 'string';
	s['version'] = 'string';
...
self._ZEN_Mojo_Plugin_dojo191DijitHelper_addProp = function(properties,instance,property,propertyToAdd,type,defaultValue,refreshMode) {
var add = '';
switch (type) {
case 'boolean':
...
self._ZEN_Mojo_Plugin_dojo191DijitHelper_addTabWithDocumentView = function(docView,tabKey,tabId,tabTitle,newDocView) {
...
self._ZEN_Mojo_Plugin_dojo191DijitHelper_clone = function(obj) {
...
self._ZEN_Mojo_Plugin_dojo191DijitHelper_createDocumentView = function(layoutKey,dataKey,id) {
...
self._ZEN_Mojo_Plugin_dojo191DijitHelper_createLayoutObjects = function(type,instance) {
...
self._ZEN_Mojo_Plugin_dojo191DijitHelper_getDojoTypes = function() {
...
self._ZEN_Mojo_Plugin_dojo191DijitHelper_getFeatures = function() {
return [
...
self._ZEN_Mojo_Plugin_dojo191DijitHelper_hideGeneric = function() {
var props = [];
...
self._ZEN_Mojo_Plugin_dojo191DijitHelper_injectDocumentViewIntoContentPane = function(documentView,key) {
...
self._ZEN_Mojo_Plugin_dojo191DijitHelper_linkDojoItem = function() {
var registry = require("dijit/registry");
var item = registry.byId(this.$makeId('dojo'));
this.$dojoItem = item;
}

self._ZEN_Mojo_Plugin_dojo191DijitHelper_observeStore = function() {
...
self._ZEN_Mojo_Plugin_dojo191DijitHelper_onCheckLibraries = function() {
...
self._ZEN_Mojo_Plugin_dojo191DijitHelper_refreshGeneric = function() {
var props = [];
var documentView = this.$documentView;
var plugin = documentView.getPluginByLayoutObjectType(this.$type);
if (this.$dojoProps) {
...
self._ZEN_Mojo_Plugin_dojo191DijitHelper_registerDojoType = function(instance) {
...
self._ZEN_Mojo_Plugin_dojo191DijitHelper_registerDojoTypeByType = function(type) {
var documentView = this.$documentView;
if (typeof this._registeredTypes == 'undefined') {
...
self._ZEN_Mojo_Plugin_dojo191DijitHelper_renderGeneric = function() {
var html = [];
var props = [];
var attributes = [];
var documentView = this.$documentView;
...
self._ZEN_Mojo_Plugin_dojo191DijitHelper_renderOptions = function() {
var html = [];
...
self._ZEN_Mojo_Plugin_dojo191DijitHelper_renderP = function() {
var html = [];
html.push('<p>');
...
self._ZEN_Mojo_Plugin_dojo191DijitHelper_renderStoreMethods = function() {
var html = [];
...
self._ZEN_Mojo_Plugin_dojo191DijitHelper_resizeDocumentViewWithinContentPane = function(documentView,cp) {
...
self._ZEN_Mojo_Plugin_dojo191DijitHelper_resizeDocumentViewWithinKey = function(documentView,key) {
...
self._ZEN_Mojo_Plugin_dojo191DijitHelper_showGeneric = function() {
var props = [];
var documentView = this.$documentView;
var plugin = documentView.getPluginByLayoutObjectType(this.$type);
switch (this.type) {
...
self._ZEN_Mojo_Plugin_dojo191DijitHelper__Loader = function() {
	zenLoadClass('_ZEN_Mojo_Plugin_baseHelperPlugin');
	_ZEN_Mojo_Plugin_dojo191DijitHelper.prototype = zenCreate('_ZEN_Mojo_Plugin_baseHelperPlugin',-1);
	var p = _ZEN_Mojo_Plugin_dojo191DijitHelper.prototype;
	if (null==p) {return;}
	p.constructor = _ZEN_Mojo_Plugin_dojo191DijitHelper;
	...
	p._serverClass = '%ZEN.Mojo.Plugin.dojo191DijitHelper';
	p._type = 'dojo191DijitHelper';
	p.serialize = _ZEN_Mojo_Plugin_dojo191DijitHelper_serialize;
	p.getSettings = _ZEN_Mojo_Plugin_dojo191DijitHelper_getSettings;
	p.addProp = _ZEN_Mojo_Plugin_dojo191DijitHelper_addProp;
	p.addTabWithDocumentView = _ZEN_Mojo_Plugin_dojo191DijitHelper_addTabWithDocumentView;
	p.clone = _ZEN_Mojo_Plugin_dojo191DijitHelper_clone;
	p.createDocumentView = _ZEN_Mojo_Plugin_dojo191DijitHelper_createDocumentView;
	p.createLayoutObjects = _ZEN_Mojo_Plugin_dojo191DijitHelper_createLayoutObjects;
	p.getDojoTypes = _ZEN_Mojo_Plugin_dojo191DijitHelper_getDojoTypes;
	p.getFeatures = _ZEN_Mojo_Plugin_dojo191DijitHelper_getFeatures;
	p.hideGeneric = _ZEN_Mojo_Plugin_dojo191DijitHelper_hideGeneric;
	p.injectDocumentViewIntoContentPane = _ZEN_Mojo_Plugin_dojo191DijitHelper_injectDocumentViewIntoContentPane;
	p.linkDojoItem = _ZEN_Mojo_Plugin_dojo191DijitHelper_linkDojoItem;
	p.observeStore = _ZEN_Mojo_Plugin_dojo191DijitHelper_observeStore;
	p.onCheckLibraries = _ZEN_Mojo_Plugin_dojo191DijitHelper_onCheckLibraries;
	p.refreshGeneric = _ZEN_Mojo_Plugin_dojo191DijitHelper_refreshGeneric;
	p.registerDojoType = _ZEN_Mojo_Plugin_dojo191DijitHelper_registerDojoType;
	p.registerDojoTypeByType = _ZEN_Mojo_Plugin_dojo191DijitHelper_registerDojoTypeByType;
	p.renderGeneric = _ZEN_Mojo_Plugin_dojo191DijitHelper_renderGeneric;
	p.renderOptions = _ZEN_Mojo_Plugin_dojo191DijitHelper_renderOptions;
	p.renderP = _ZEN_Mojo_Plugin_dojo191DijitHelper_renderP;
	p.renderStoreMethods = _ZEN_Mojo_Plugin_dojo191DijitHelper_renderStoreMethods;
	p.resizeDocumentViewWithinContentPane = _ZEN_Mojo_Plugin_dojo191DijitHelper_resizeDocumentViewWithinContentPane;
	p.resizeDocumentViewWithinKey = _ZEN_Mojo_Plugin_dojo191DijitHelper_resizeDocumentViewWithinKey;
	p.showGeneric = _ZEN_Mojo_Plugin_dojo191DijitHelper_showGeneric;
}
/* EOF */