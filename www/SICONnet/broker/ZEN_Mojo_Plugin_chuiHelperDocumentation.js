/*** Zen Module: ZEN_Mojo_Plugin_chuiHelperDocumentation ***/

self._zenClassIdx['http://www.intersystems.com/zen/mojo/chuiHelperDocumentation'] = '_ZEN_Mojo_Plugin_chuiHelperDocumentation';
self._ZEN_Mojo_Plugin_chuiHelperDocumentation = function(index,id) {
	if (index>=0) {_ZEN_Mojo_Plugin_chuiHelperDocumentation__init(this,index,id);}
}

self._ZEN_Mojo_Plugin_chuiHelperDocumentation__init = function(o,index,id) {
...
function _ZEN_Mojo_Plugin_chuiHelperDocumentation_serialize(set,s)
{
...
function _ZEN_Mojo_Plugin_chuiHelperDocumentation_getSettings(s)
{
	s['name'] = 'string';
	this.invokeSuper('getSettings',arguments);
}

self._ZEN_Mojo_Plugin_chuiHelperDocumentation_getDocumentation = function(identifier) {
...
self._ZEN_Mojo_Plugin_chuiHelperDocumentation__Loader = function() {
	zenLoadClass('_ZEN_Mojo_Plugin_baseHelperDocumentation');
	_ZEN_Mojo_Plugin_chuiHelperDocumentation.prototype = zenCreate('_ZEN_Mojo_Plugin_baseHelperDocumentation',-1);
	var p = _ZEN_Mojo_Plugin_chuiHelperDocumentation.prototype;
	if (null==p) {return;}
	p.constructor = _ZEN_Mojo_Plugin_chuiHelperDocumentation;
	...
	p._serverClass = '%ZEN.Mojo.Plugin.chuiHelperDocumentation';
	p._type = 'chuiHelperDocumentation';
	p.serialize = _ZEN_Mojo_Plugin_chuiHelperDocumentation_serialize;
	p.getSettings = _ZEN_Mojo_Plugin_chuiHelperDocumentation_getSettings;
	p.getDocumentation = _ZEN_Mojo_Plugin_chuiHelperDocumentation_getDocumentation;
}
/* EOF */