/*** Zen Module: ZEN_Mojo_Plugin_dojo191PageManager ***/

self._zenClassIdx['http://www.intersystems.com/zen/mojo/dojo-1.9.1-PageManager'] = '_ZEN_Mojo_Plugin_dojo191PageManager';
self._ZEN_Mojo_Plugin_dojo191PageManager = function(index,id) {
	if (index>=0) {_ZEN_Mojo_Plugin_dojo191PageManager__init(this,index,id);}
}

self._ZEN_Mojo_Plugin_dojo191PageManager__init = function(o,index,id) {
	...
	o.bodyClass = 'claro';
	o.onPageShow = '';
	o.pluginName = 'dojo-1.9.1-PageManager';
	o.suppressCodeExecution = true;
	o.suppressStopPropagation = true;
	o.version = '1.0.2';
}
function _ZEN_Mojo_Plugin_dojo191PageManager_serialize(set,s)
{
...
function _ZEN_Mojo_Plugin_dojo191PageManager_getSettings(s)
{
	s['name'] = 'string';
	s['bodyClass'] = 'string';
...
self._ZEN_Mojo_Plugin_dojo191PageManager_addTabWithDocumentView = function(docView,tabKey,tabId,tabTitle,newDocView) {
...
self._ZEN_Mojo_Plugin_dojo191PageManager_afterParse = function(docView) {
...
self._ZEN_Mojo_Plugin_dojo191PageManager_afterRenderDocument = function(docView,displayMode,html) {
...
self._ZEN_Mojo_Plugin_dojo191PageManager_createDocumentView = function(layoutKey,dataKey,id) {
...
self._ZEN_Mojo_Plugin_dojo191PageManager_injectDocumentViewIntoContentPane = function(documentView,key) {
...
self._ZEN_Mojo_Plugin_dojo191PageManager_onCheckLibraries = function() {
...
self._ZEN_Mojo_Plugin_dojo191PageManager_resizeDocumentViewWithinContentPane = function(documentView,cp) {
...
self._ZEN_Mojo_Plugin_dojo191PageManager_resizeDocumentViewWithinKey = function(documentView,key) {
...
self._ZEN_Mojo_Plugin_dojo191PageManager__Loader = function() {
	zenLoadClass('_ZEN_Mojo_Plugin_basePageManager');
	_ZEN_Mojo_Plugin_dojo191PageManager.prototype = zenCreate('_ZEN_Mojo_Plugin_basePageManager',-1);
	var p = _ZEN_Mojo_Plugin_dojo191PageManager.prototype;
	if (null==p) {return;}
	p.constructor = _ZEN_Mojo_Plugin_dojo191PageManager;
	...
	p._serverClass = '%ZEN.Mojo.Plugin.dojo191PageManager';
	p._type = 'dojo191PageManager';
	p.serialize = _ZEN_Mojo_Plugin_dojo191PageManager_serialize;
	p.getSettings = _ZEN_Mojo_Plugin_dojo191PageManager_getSettings;
	p.addTabWithDocumentView = _ZEN_Mojo_Plugin_dojo191PageManager_addTabWithDocumentView;
	p.afterParse = _ZEN_Mojo_Plugin_dojo191PageManager_afterParse;
	p.afterRenderDocument = _ZEN_Mojo_Plugin_dojo191PageManager_afterRenderDocument;
	p.createDocumentView = _ZEN_Mojo_Plugin_dojo191PageManager_createDocumentView;
	p.injectDocumentViewIntoContentPane = _ZEN_Mojo_Plugin_dojo191PageManager_injectDocumentViewIntoContentPane;
	p.onCheckLibraries = _ZEN_Mojo_Plugin_dojo191PageManager_onCheckLibraries;
	p.resizeDocumentViewWithinContentPane = _ZEN_Mojo_Plugin_dojo191PageManager_resizeDocumentViewWithinContentPane;
	p.resizeDocumentViewWithinKey = _ZEN_Mojo_Plugin_dojo191PageManager_resizeDocumentViewWithinKey;
}
/* EOF */