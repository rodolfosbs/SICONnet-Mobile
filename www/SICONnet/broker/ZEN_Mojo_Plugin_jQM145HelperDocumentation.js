/*** Zen Module: ZEN_Mojo_Plugin_jQM145HelperDocumentation ***/

self._zenClassIdx['http://www.intersystems.com/zen/mojo/jQM145HelperDocumentation'] = '_ZEN_Mojo_Plugin_jQM145HelperDocumentation';
self._ZEN_Mojo_Plugin_jQM145HelperDocumentation = function(index,id) {
	if (index>=0) {_ZEN_Mojo_Plugin_jQM145HelperDocumentation__init(this,index,id);}
}

self._ZEN_Mojo_Plugin_jQM145HelperDocumentation__init = function(o,index,id) {
...
function _ZEN_Mojo_Plugin_jQM145HelperDocumentation_serialize(set,s)
{
...
function _ZEN_Mojo_Plugin_jQM145HelperDocumentation_getSettings(s)
{
	s['name'] = 'string';
	this.invokeSuper('getSettings',arguments);
}

self._ZEN_Mojo_Plugin_jQM145HelperDocumentation_getDocumentation = function(identifier) {
...
{name:'content',type:'string',refreshable:true,description:''},
{name:'controlClass',type:'string',refreshable:false,description:''},
{name:'controlStyle',type:'string',refreshable:true,description:''},
{name:'dataiconpos',type:'string',refreshable:true,description:'Corresponds to the data-iconpos attribute.'},
{name:'dataTheme',type:'string',refreshable:true,description:'Corresponds to the data-theme attribute.'},
{name:'disabled',type:'boolean',refreshable:true,description:'If this property is true, Zen Mojo disables this object by adding the HTML disabled attribute.'},
{name:'fieldcontain',type:'boolean',refreshable:false,description:'If this property is true, Zen Mojo encloses this layout object in a <div> element with class=""ui-field-contain"".'},
{name:'hidden',type:'boolean',refreshable:true,description:'If this property is true, Zen Mojo hides this layout object by including the HTML hidden attribute.'},
{name:'key',type:'string',refreshable:false,description:'Key that identifies this layout object. The name of a key cannot include a colon (:).'},
...
{name:'hidden',type:'boolean',refreshable:true,description:'If this property is true, Zen Mojo hides this layout object by including the HTML hidden attribute.'},
{name:'inset',type:'boolean',refreshable:false,description:'Corresponds to the data-inset attribute.'},
{name:'key',type:'string',refreshable:false,description:'Key that identifies this layout object. The name of a key cannot include a colon (:).'},
{name:'label',type:'string',refreshable:true,description:'Used as the legend of this layout object.'},
{name:'mini',type:'boolean',refreshable:true,description:'Corresponds to the data-mini attribute.'},
{name:'value',type:'array',refreshable:false,description:'An array of objects, each of which has the attributes label and key.'},				]
};
break;
case '$collapsibleset':
documentation = {
...
attributes:[
{name:'barTheme',type:'string',refreshable:true,description:'Specifies the theme to use if showBox is true.'},
...
{name:'columnCount',type:'number',refreshable:true,description:'Specifies the number of columns in the grid. Specify 1, 2, 3, 4, or 5. If you specify a number greater than 5, Zen Mojo creates 5 columns.'},
{name:'cssClass',type:'string',refreshable:true,description:'Specifies the CSS class to use.'},
{name:'hidden',type:'boolean',refreshable:true,description:'If this property is true, Zen Mojo hides this layout object by including the HTML hidden attribute.'},
{name:'key',type:'string',refreshable:false,description:'Key that identifies this layout object. The name of a key cannot include a colon (:).'},
{name:'showBox',type:'boolean',refreshable:true,description:' If this property is false (the default), the grid is used only for layout and has no associated theme (grid is transparent). If this property is true, Zen Mojo applies a theme to the grid. This is barTheme or (if barTheme is not set) the global jQueryBarTheme.'},
{name:'style',type:'string',refreshable:true,description:''},				]
};
break;
case '$header':
...
{name:'updateLayoutOnBack',type:'boolean',refreshable:false,description:'If this property is true, Zen Mojo pops the document off the stack when the user presses the back button.'},				]
};
break;
case '$input':
documentation = {
...
attributes:[
{name:'$ignoreChange',type:'boolean',refreshable:false,description:'If true, suppress default generation of onchange handlers.'},
{name:'$ignoreEvent',type:'boolean',refreshable:false,description:'If true, suppress default generation of keyup handlers.'},
...
{name:'hidden',type:'boolean',refreshable:true,description:'If this property is true, Zen Mojo hides this layout object by including the HTML hidden attribute.'},
{name:'highlight',type:'boolean',refreshable:true,description:'Corresponds to the data-highlight attribute.'},
...
{name:'valueList',type:'',refreshable:true,description:'This property can be an array of objects, each of which has ""value"", ""text"", and optional ""disabled"" properties.  Or the property can be a string containing a comma-separated list of values.'},				]
};
break;
case '$link':
documentation = {
...
{name:'caption',type:'string',refreshable:true,description:'Specifies the caption for this item.'},
{name:'controlClass',type:'string',refreshable:true,description:''},
{name:'controlStyle',type:'string',refreshable:true,description:''},
{name:'dataTheme',type:'string',refreshable:true,description:'Corresponds to the data-theme attribute.'},
{name:'hidden',type:'boolean',refreshable:true,description:'If this property is true, Zen Mojo hides this layout object by including the HTML hidden attribute.'},
{name:'image',type:'string',refreshable:true,description:''},
{name:'imageClass',type:'string',refreshable:true,description:''},
{name:'imageStyle',type:'string',refreshable:true,description:''},
{name:'key',type:'string',refreshable:false,description:'Key that identifies this layout object. The name of a key cannot include a colon (:).'},
{name:'mini',type:'boolean',refreshable:true,description:'Corresponds to the data-mini attribute.'},				]
};
break;
...
{name:'labelNoWrapper',type:'boolean',refreshable:true,description:'If this attribute is false, Zen Mojo wraps the label (if any) in an HTML <h2> element. If this attribute is true, Zen Mojo includes the label (if any) as is.'},
...
attributes:[
{name:'$ignoreSelect',type:'boolean',refreshable:true,description:'If true, suppress default generation of select handlers.'},
{name:'active',type:'boolean',refreshable:true,description:'If this attribute is true, Zen Mojo adds ui-btn-active to the class attribute for the item.'},
{name:'caption',type:'string',refreshable:true,description:'Specifies the caption for this item.'},
{name:'dataiconpos',type:'string',refreshable:true,description:'Corresponds to the data-iconpos attribute.'},
{name:'dataTheme',type:'string',refreshable:true,description:'Corresponds to the data-theme attribute.'},
{name:'hidden',type:'boolean',refreshable:true,description:'If this property is true, Zen Mojo hides this layout object by including the HTML hidden attribute.'},
{name:'icon',type:'string',refreshable:true,description:'Corresponds to the data-icon attribute.'},
{name:'key',type:'string',refreshable:false,description:'Key that identifies this layout object. The name of a key cannot include a colon (:).'},
{name:'persist',type:'boolean',refreshable:true,description:'If this attribute is true, Zen Mojo adds ui-state-persist to the class attribute for the item.'},				]
};
break;
case '$pagecontent':
documentation = {
...
attributes:[
{name:'animate',type:'boolean',refreshable:true,description:'Corresponds to the data-animate attribute.'},
{name:'children',type:'array',refreshable:false,description:'Child layout objects to contain within this widget. These can be layout objects defined by the same plugin (most common), layout objects defined by other plugins, or a mix.'},
{name:'dataTheme',type:'string',refreshable:true,description:'Corresponds to the data-theme attribute.'},
...
{name:'autocapitalize',type:'boolean',refreshable:true,description:''},
{name:'autocorrect',type:'boolean',refreshable:true,description:''},
{name:'codeTable',type:'',refreshable:false,description:''},
{name:'controlClass',type:'string',refreshable:false,description:''},
{name:'controlStyle',type:'string',refreshable:true,description:''},
{name:'disabled',type:'boolean',refreshable:true,description:''},
{name:'fieldContain',type:'boolean',refreshable:false,description:'If this property is true, Zen Mojo encloses this layout object in a <div> element that has data-role=""fieldcontain"".'},
{name:'format',type:'string',refreshable:false,description:''},
{name:'hidden',type:'boolean',refreshable:true,description:''},
{name:'highlight',type:'boolean',refreshable:true,description:''},
{name:'key',type:'string',refreshable:false,description:'Key that identifies this layout object. The name of a key cannot include a colon (:).'},
{name:'label',type:'string',refreshable:true,description:''},
{name:'max',type:'number',refreshable:false,description:''},
{name:'min',type:'number',refreshable:false,description:''},
{name:'mini',type:'boolean',refreshable:true,description:'Corresponds to the data-mini attribute.'},
...
{name:'spellcheck',type:'boolean',refreshable:true,description:''},
{name:'step',type:'number',refreshable:false,description:''},
{name:'text',type:'string',refreshable:false,description:''},
{name:'value',type:'string',refreshable:false,description:''},
{name:'valueList',type:'array',refreshable:false,description:''},				]
};
break;
case '$popup':
documentation = {
...
{name:'corners',type:'boolean',refreshable:true,description:'Corresponds to the data-corners attribute.'},
{name:'cssClass',type:'string',refreshable:false,description:''},
{name:'dataOverlayTheme',type:'boolean',refreshable:false,description:'Corresponds to the data-overlay-theme attribute.'},
{name:'dataTheme',type:'string',refreshable:true,description:'Corresponds to the data-theme attribute.'},
{name:'dismissible',type:'boolean',refreshable:true,description:'Corresponds to the data-dismissible attribute.'},
...
{name:'dataTrackTheme',type:'string',refreshable:true,description:'Corresponds to the data-track-theme attribute.'},
{name:'disabled',type:'boolean',refreshable:true,description:'If this property is true, Zen Mojo disables this object by adding the HTML disabled attribute.'},
{name:'disabledList',type:'string',refreshable:true,description:'Use this property if you specify a comma-separated list for valueList in the optGroups array. If specified, disabledList should be a comma-separated list of true and false values, to control which options are disabled.'},
{name:'fieldcontain',type:'boolean',refreshable:false,description:'If this property is true, Zen Mojo encloses this layout object in a <div> element with class=""ui-field-contain"".'},
{name:'flipswitch',type:'boolean',refreshable:false,description:'If this property is true, Zen Mojo adds data-role=""flipswitch"" to the rendered element.'},
{name:'hidden',type:'boolean',refreshable:true,description:'If this property is true, Zen Mojo hides this layout object by including the HTML hidden attribute.'},
{name:'key',type:'string',refreshable:false,description:'Key that identifies this layout object. The name of a key cannot include a colon (:).'},
{name:'label',type:'string',refreshable:true,description:''},
{name:'mini',type:'boolean',refreshable:true,description:'Corresponds to the data-mini attribute.'},
...
{name:'size',type:'number',refreshable:false,description:''},
{name:'slider',type:'boolean',refreshable:false,description:'If this property is true, Zen Mojo adds data-role=""flipswitch"" to the rendered element.'},
{name:'value',type:'string',refreshable:false,description:''},
{name:'valueList',type:'array',refreshable:true,description:'Array of objects. Each object must have the properties value and text.'},				]
};
break;
case '$string':
documentation = {
...
{name:'autocapitalize',type:'boolean',refreshable:true,description:''},
{name:'autocorrect',type:'boolean',refreshable:true,description:''},
{name:'cols',type:'number',refreshable:false,description:''},
{name:'controlClass',type:'string',refreshable:false,description:''},
{name:'controlStyle',type:'string',refreshable:true,description:''},
{name:'disabled',type:'boolean',refreshable:true,description:'If this property is true, Zen Mojo disables this object by adding the HTML disabled attribute.'},
{name:'fieldcontain',type:'boolean',refreshable:false,description:'If this property is true, Zen Mojo encloses this layout object in a <div> element with class=""ui-field-contain"".'},
...
{name:'mini',type:'boolean',refreshable:true,description:'Corresponds to the data-mini attribute.'},
{name:'placeHolder',type:'string',refreshable:true,description:''},
{name:'required',type:'boolean',refreshable:false,description:''},
{name:'rows',type:'number',refreshable:false,description:''},
{name:'spellcheck',type:'boolean',refreshable:false,description:''},
{name:'value',type:'string',refreshable:false,description:''},				]
};
break;
}
...
self._ZEN_Mojo_Plugin_jQM145HelperDocumentation__Loader = function() {
	zenLoadClass('_ZEN_Mojo_Plugin_baseHelperDocumentation');
	_ZEN_Mojo_Plugin_jQM145HelperDocumentation.prototype = zenCreate('_ZEN_Mojo_Plugin_baseHelperDocumentation',-1);
	var p = _ZEN_Mojo_Plugin_jQM145HelperDocumentation.prototype;
	if (null==p) {return;}
	p.constructor = _ZEN_Mojo_Plugin_jQM145HelperDocumentation;
	...
	p._serverClass = '%ZEN.Mojo.Plugin.jQM145HelperDocumentation';
	p._type = 'jQM145HelperDocumentation';
	p.serialize = _ZEN_Mojo_Plugin_jQM145HelperDocumentation_serialize;
	p.getSettings = _ZEN_Mojo_Plugin_jQM145HelperDocumentation_getSettings;
	p.getDocumentation = _ZEN_Mojo_Plugin_jQM145HelperDocumentation_getDocumentation;
}
/* EOF */