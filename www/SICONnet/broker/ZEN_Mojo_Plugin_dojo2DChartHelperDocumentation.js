/*** Zen Module: ZEN_Mojo_Plugin_dojo2DChartHelperDocumentation ***/

self._zenClassIdx['http://www.intersystems.com/zen/mojo/dojo2DChartHelperDocumentation'] = '_ZEN_Mojo_Plugin_dojo2DChartHelperDocumentation';
self._ZEN_Mojo_Plugin_dojo2DChartHelperDocumentation = function(index,id) {
	if (index>=0) {_ZEN_Mojo_Plugin_dojo2DChartHelperDocumentation__init(this,index,id);}
}

self._ZEN_Mojo_Plugin_dojo2DChartHelperDocumentation__init = function(o,index,id) {
...
function _ZEN_Mojo_Plugin_dojo2DChartHelperDocumentation_serialize(set,s)
{
...
function _ZEN_Mojo_Plugin_dojo2DChartHelperDocumentation_getSettings(s)
{
	s['name'] = 'string';
	this.invokeSuper('getSettings',arguments);
}

self._ZEN_Mojo_Plugin_dojo2DChartHelperDocumentation_getDocumentation = function(identifier) {
...
self._ZEN_Mojo_Plugin_dojo2DChartHelperDocumentation__Loader = function() {
	zenLoadClass('_ZEN_Mojo_Plugin_baseHelperDocumentation');
	_ZEN_Mojo_Plugin_dojo2DChartHelperDocumentation.prototype = zenCreate('_ZEN_Mojo_Plugin_baseHelperDocumentation',-1);
	var p = _ZEN_Mojo_Plugin_dojo2DChartHelperDocumentation.prototype;
	if (null==p) {return;}
	p.constructor = _ZEN_Mojo_Plugin_dojo2DChartHelperDocumentation;
	...
	p._serverClass = '%ZEN.Mojo.Plugin.dojo2DChartHelperDocumentation';
	p._type = 'dojo2DChartHelperDocumentation';
	p.serialize = _ZEN_Mojo_Plugin_dojo2DChartHelperDocumentation_serialize;
	p.getSettings = _ZEN_Mojo_Plugin_dojo2DChartHelperDocumentation_getSettings;
	p.getDocumentation = _ZEN_Mojo_Plugin_dojo2DChartHelperDocumentation_getDocumentation;
}
/* EOF */