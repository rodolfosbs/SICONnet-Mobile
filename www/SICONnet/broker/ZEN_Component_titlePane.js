/*** Zen Module: ZEN_Component_titlePane ***/

self._zenClassIdx['titlePane'] = '_ZEN_Component_titlePane';
self._ZEN_Component_titlePane = function(index,id) {
	if (index>=0) {_ZEN_Component_titlePane__init(this,index,id);}
}

self._ZEN_Component_titlePane__init = function(o,index,id) {
...
self._ZEN_Component_titlePane_ReallyRefreshContents = function() {
	zenInstanceMethod(this,'ReallyRefreshContents','','',arguments);
}
self._ZEN_Component_titlePane__Loader = function() {
