/*** Zen Module: ZEN_Mojo_Plugin_jQM132Helper ***/

self._zenClassIdx['http://www.intersystems.com/zen/mojo/jQM-1.3.2-Helper'] = '_ZEN_Mojo_Plugin_jQM132Helper';
self._ZEN_Mojo_Plugin_jQM132Helper = function(index,id) {
	if (index>=0) {_ZEN_Mojo_Plugin_jQM132Helper__init(this,index,id);}
}

self._ZEN_Mojo_Plugin_jQM132Helper__init = function(o,index,id) {
	...
	o.pluginName = 'jQM-1.3.2-Helper';
	o.version = '1.0.26';
}
function _ZEN_Mojo_Plugin_jQM132Helper_serialize(set,s)
{
...
function _ZEN_Mojo_Plugin_jQM132Helper_getSettings(s)
{
	s['name'] = 'string';
...
self._ZEN_Mojo_Plugin_jQM132Helper_buildOptions = function() {
var html = [];
...
self._ZEN_Mojo_Plugin_jQM132Helper_changeTheme = function(newTheme,headerTheme,barTheme) {
var rmbtnClasses = '';
var rmhfClasses = '';
var rmbdClassess = '';
...
self._ZEN_Mojo_Plugin_jQM132Helper_closePanel = function(id) {
...
self._ZEN_Mojo_Plugin_jQM132Helper_closePopup = function(key) {
$('#'+this.$documentView.getItemByKey(key).$makeId()).popup('close');
}

self._ZEN_Mojo_Plugin_jQM132Helper_createLayoutObjects = function(type,instance) {
...
instance.$refresh = this.refreshPanel;
break;
case '$pagecontent':
...
self._ZEN_Mojo_Plugin_jQM132Helper_decorateControl = function(instance) {
...
self._ZEN_Mojo_Plugin_jQM132Helper_getDisplayText = function() {
var text = '';
var type = this.$type;
switch(type){
case '$button':
...
self._ZEN_Mojo_Plugin_jQM132Helper_getFeatures = function() {
var features = [
...
self._ZEN_Mojo_Plugin_jQM132Helper_hideElement = function(duration,callback) {
...
self._ZEN_Mojo_Plugin_jQM132Helper_onCheckLibraries = function() {
if (typeof $ === 'undefined') {
...
self._ZEN_Mojo_Plugin_jQM132Helper_openPanel = function(id) {
var targetPanel = $('#'+this.$documentView.currLevel+'-'+id);
if (targetPanel.length<1) {
var targetPanel = $('#'+this.$documentView.getItemByKey(id).$makeId());
}
...
self._ZEN_Mojo_Plugin_jQM132Helper_refreshButton = function() {
var options = {};
var jqmItem = $('#'+this.$makeId());
if (zenGet(this.corners) !== '') {
options['corners'] = this.corners?true:false;
}
if (zenGet(this.dataicon) !== '') {
options['icon'] = this.dataicon;
}
if (zenGet(this.dataiconpos) !== '') {
options['iconpos'] = this.dataiconpos;
}
if (zenGet(this.dataiconshadow) !== '') {
options['iconshadow'] = this.dataiconshadow?true:false;
}
if (zenGet(this.dataTheme) !== '') {
options['theme'] = this.dataTheme;
}
if (zenGet(this.mini) !== '') {
options['mini'] = this.mini?true:false;
}
if (zenGet(this.shadow) !== '') {
options['shadow'] = this.shadow?true:false;
}
if (zenGet(this.caption) !== '' || zenGet(this.content) !== '') {
this.$setValue(zenGet(this.caption,this.content));
}
...
options['disabled'] = this.disabled?true:false;
jqmItem.attr('disabled',options['disabled']);
}
jqmItem.button('refresh').buttonMarkup(options);
if (zenGet(this.hidden) !== '') {this.hidden?this.$hide():this.$show();}
}

self._ZEN_Mojo_Plugin_jQM132Helper_refreshCheckboxRadio = function() {
var options = {};
var attributes = {};
var jqmItem = $('#'+this.$makeId());
if (zenGet(this.controlStyle) !== '') {
this.$findElement().setAttribute('style',zenGet(this.controlStyle));
}
if (zenGet(this.dataiconpos) !== '') {
options['iconpos'] = this.dataiconpos;
attributes['iconpos'] = 'data-iconpos';
}
if (zenGet(this.dataTheme) !== '') {
options['theme'] = this.dataTheme;
...
if (zenGet(this.mini) !== '') {
options['mini'] = this.mini?true:false;
attributes['mini'] = 'data-mini';
}
var jqmLabel = $('label[for = '+this.$makeId()+']');
if (zenGet(this.value) !== '' || zenGet(this.checked) !== '') {
jqmItem.prop('checked',zenGet(this.value,this.checked)?true:false);
}
var label = '';
if (zenGet(this.label) !== '') {label = this.label;}
else if (zenGet(this.text) !== '') {label = this.text;}
if (label && $('label[for = '+this.$makeId()+']').length > 0) {
jqmLabel.find('.ui-btn-text').text(label);
}
for (var x in options) {
if (zenGet(options[x] !== '')) {
jqmItem.attr(attributes[x],options[x]);
jqmLabel.attr(attributes[x],options[x]);
}
}
jqmItem.checkboxradio('refresh');
if (zenGet(this.hidden) !== '') {this.hidden?this.$hide():this.$show();}
}

self._ZEN_Mojo_Plugin_jQM132Helper_refreshCollapsible = function() {
var jqmItem = $('#'+this.$makeId());
if (zenGet(this.label) !== '' && $('label[for = '+this.$makeId()+']').length > 0) {
$('label[for = '+this.$makeId()+']').text(this.label);
}
jqmItem.replaceWith(this.$render());
$('#'+this.$makeId()).collapsible();
if (zenGet(this.hidden) !== '') {this.hidden?this.$hide():this.$show();}
}

self._ZEN_Mojo_Plugin_jQM132Helper_refreshCollapsibleSet = function() {
var jqmItem = $('#'+this.$makeId());
jqmItem.replaceWith(this.$render());
$('#'+this.$makeId()).collapsibleset();
if (zenGet(this.hidden) !== '') {this.hidden?this.$hide():this.$show();}
}

self._ZEN_Mojo_Plugin_jQM132Helper_refreshControlGroup = function() {
var options = {};
var jqmItem = $('#'+this.$makeId());
if (zenGet(this.horizontal) !== '') {
options['type'] = this.horizontal?'horizontal':'vertical';
}
jqmItem.controlgroup('option',options);
if (zenGet(this.hidden) !== '') {this.hidden?this.$hide():this.$show();}
}

self._ZEN_Mojo_Plugin_jQM132Helper_refreshFieldSet = function() {
var options = {};
var jqmItem = $('#'+this.$makeId());
if (zenGet(this.dataiconpos) !== '') {
options['iconpos'] = this.dataiconpos;
...
if (jqmItem.find('legend').length > 0) {
jqmItem.find('legend').text(this.label);
}
}
jqmItem.controlgroup('option',options);
if (zenGet(this.hidden) !== '') {this.hidden?this.$hide():this.$show();}
...
self._ZEN_Mojo_Plugin_jQM132Helper_refreshFooter = function() {
var jqmItem = $('#'+this.$makeId());
...
self._ZEN_Mojo_Plugin_jQM132Helper_refreshHeader = function() {
var jqmItem = $('#'+this.$makeId());
var caption = zenGet(this.captionContent,this.caption);
if (caption !== '' && jqmItem.children('h1').length > 0) {
jqmItem.children('h1').text(caption);
...
self._ZEN_Mojo_Plugin_jQM132Helper_refreshInput = function() {
if(this.inputType == 'range'){
this.$refresh2 = this.$documentView.getPluginByLayoutObjectType(this.$type).refreshRange;
this.$refresh2();
}
else{
var jqmItem = $('#'+this.$makeId());
$('label[for = '+this.$makeId()+']').remove();
if(this.$type == '$textarea'){jqmItem.replaceWith(this.$render());}
else{jqmItem.parent().replaceWith(this.$render());}
$('#'+this.$makeId()).textinput();
if (zenGet(this.hidden) !== '') {this.hidden?this.$hide():this.$show();}
}
}

self._ZEN_Mojo_Plugin_jQM132Helper_refreshListView = function() {
var jqmItem = $('#'+this.$makeId());
if (zenGet(this.style) !== '') {this.$findElement().setAttribute('style',zenGet(this.style));}
if (jqmItem.prev().hasClass('ui-listview-filter')) {
jqmItem.prev().remove();
}
jqmItem.replaceWith(this.$render());
...
self._ZEN_Mojo_Plugin_jQM132Helper_refreshListViewItem = function() {
var jqmItem = $('#'+this.$makeId());
if (zenGet(this.label) !== '' && $('label[for = '+this.$makeId()+']').length > 0) {
$('label[for = '+this.$makeId()+']').text(this.label);
}
...
self._ZEN_Mojo_Plugin_jQM132Helper_refreshPanel = function() {
var options = {};
var jqmItem = $('#'+this.$makeId());
if (zenGet(this.dataTheme) !== '') {
options['theme'] = this.dataTheme;
}
if (zenGet(this.dismissible) !== '') {
options['dismissible'] = this.dismissible;
}
...
self._ZEN_Mojo_Plugin_jQM132Helper_refreshPopup = function() {
var options = {};
var jqmItem = $('#'+this.$makeId());
if (zenGet(this.corners) !== '') {
options['corners'] = this.corners?true:false;
...
if (zenGet(this.dataOverlayTheme) !== '') {options['overlayTheme'] = this.dataOverlayTheme;}
if (zenGet(this.transition) !== '') {options['transition'] = this.transition;}
jqmItem.popup('option',options);
if (zenGet(this.hidden) !== '') {this.hidden?this.$hide():this.$show();}
}

self._ZEN_Mojo_Plugin_jQM132Helper_refreshRange = function() {
var options = {};
var jqmItem = $('#'+this.$makeId());
if (zenGet(this.clearButton) !== '') {
options['clearBtn'] = this.clearButton?true:false;
}
if (zenGet(this.dataTheme) !== '') {
options['theme'] = this.dataTheme;
}
if (zenGet(this.dataTrackTheme) !== '') {
options['trackTheme'] = this.dataTrackTheme;
}
if (zenGet(this.highlight) !== '') {
options['highlight'] = this.highlight?true:false;
}
if (zenGet(this.mini) !== '') {
options['mini'] = this.mini?true:false;
}
...
jqmItem.slider('option',options);
if (zenGet(this.hidden) !== '') {this.hidden?this.$hide():this.$show();}
}

self._ZEN_Mojo_Plugin_jQM132Helper_refreshSelect = function() {
if(this.slider){
this.$refresh2 = this.$documentView.getPluginByLayoutObjectType(this.$type).refreshRange;
this.$refresh2();
}
...
jqmItem.selectmenu('refresh', true);
if (zenGet(this.hidden) !== '') {this.hidden?this.$hide():this.$show();}
}
}

self._ZEN_Mojo_Plugin_jQM132Helper_renderButton = function() {
var html = [];
...
self._ZEN_Mojo_Plugin_jQM132Helper_renderCheckbox = function() {
var html = [];
...
self._ZEN_Mojo_Plugin_jQM132Helper_renderCollapsible = function() {
var html = [];
var docView = this.$documentView;
var dataTheme = zenGet(this.dataTheme,false) ? 'data-theme="'+this.dataTheme+'"' : '';
...
self._ZEN_Mojo_Plugin_jQM132Helper_renderCollapsibleSet = function() {
var html = [];
var docView = this.$documentView;
var dataTheme = zenGet(this.dataTheme,false) ? 'data-theme="'+this.dataTheme+'"' : '';
...
self._ZEN_Mojo_Plugin_jQM132Helper_renderContentBlock = function() {
var html = [];
var docView = this.$documentView;
var hidden = zenGet(this.hidden,false) ? 'display: none;' : '';
var onSelect = zenGet(this.$ignoreSelect,false) ? '': 'onclick="$$$event(\'click\');"';
...
self._ZEN_Mojo_Plugin_jQM132Helper_renderControl = function() {
var html = [];
var docView = this.$documentView;
...
self._ZEN_Mojo_Plugin_jQM132Helper_renderControlGroup = function() {
var html = [];
var docView = this.$documentView;
...
self._ZEN_Mojo_Plugin_jQM132Helper_renderFieldSet = function() {
var html = [];
var docView = this.$documentView;
var hz = zenGet(this.horizontal,false) ? 'data-type="horizontal"' : '';
var mini = zenGet(this.mini) ? 'data-mini="true"' : '';
...
self._ZEN_Mojo_Plugin_jQM132Helper_renderFooter = function() {
var html = [];
var docView = this.$documentView;
...
self._ZEN_Mojo_Plugin_jQM132Helper_renderGrid = function() {
var html = [];
var docView = this.$documentView;
...
self._ZEN_Mojo_Plugin_jQM132Helper_renderHeader = function() {
var html = [];
var docView = this.$documentView;
var dataTheme = zenGet(this.dataTheme,false) ? 'data-theme="'+this.dataTheme+'"' : 'data-theme="'+this.$documentView.getPluginByLayoutObjectType(this.$type).jQueryHeaderTheme+'"';
var fixed = zenGet(this.fixed,true) ? 'data-position="fixed"' : '';
...
self._ZEN_Mojo_Plugin_jQM132Helper_renderInput = function() {
var html = [];
...
self._ZEN_Mojo_Plugin_jQM132Helper_renderLink = function() {
var html = [];
var mini = zenGet(this.mini) ? 'data-mini="true"' : '';
var hidden = zenGet(this.hidden,false) ? 'display: none;' : '';
var dataTheme = zenGet(this.dataTheme,false) ? 'data-theme="'+this.dataTheme+'"' : '';
...
self._ZEN_Mojo_Plugin_jQM132Helper_renderListView = function() {
var html = [];
var docView = this.$documentView;
...
self._ZEN_Mojo_Plugin_jQM132Helper_renderListViewItem = function() {
var html = [];
var docView = this.$documentView;
...
self._ZEN_Mojo_Plugin_jQM132Helper_renderNavBar = function() {
var html = [];
var docView = this.$documentView;
var dataiconpos = (zenGet(this.dataiconpos,'').length > 0) ? 'data-iconpos="'+zenGet(this.dataiconpos)+'"' : '';
var hidden = zenGet(this.hidden,false) ? 'display: none;' : '';
...
self._ZEN_Mojo_Plugin_jQM132Helper_renderNavBarItem = function() {
var html = [];
var docView = this.$documentView;
this.idAlias = {};
var dataiconpos = (zenGet(this.dataiconpos,'').length > 0) ? 'data-iconpos="'+zenGet(this.dataiconpos)+'"' : '';
...
self._ZEN_Mojo_Plugin_jQM132Helper_renderPanel = function() {
var html = [];
var docView = this.$documentView;
...
self._ZEN_Mojo_Plugin_jQM132Helper_renderPopup = function() {
var html = [];
var docView = this.$documentView;
var dataTheme = zenGet(this.dataTheme,false) ? 'data-theme="'+this.dataTheme+'"' : '';
...
self._ZEN_Mojo_Plugin_jQM132Helper_renderRadioButton = function() {
var html = [];
var value = zenGet(this.value);
...
self._ZEN_Mojo_Plugin_jQM132Helper_renderSelect = function() {
var html = [];
...
self._ZEN_Mojo_Plugin_jQM132Helper_renderTextArea = function() {
var html = [];
var reqd = zenGet(this.required) ? 'required="yes"' : '';
var dis = zenGet(this.disabled) ? 'disabled="yes"' : '';
var mini = zenGet(this.mini) ? 'data-mini="true"' : '';
...
self._ZEN_Mojo_Plugin_jQM132Helper_showElement = function(duration,callback) {
if (this.fieldcontain && $('#'+this.$makeId()).closest('div[data-role="fieldcontain"]').length > 0) {
...
self._ZEN_Mojo_Plugin_jQM132Helper_showPopup = function(key,options) {
if (!options) {
options = {};
}
...
self._ZEN_Mojo_Plugin_jQM132Helper_togglePanel = function(id) {
var targetPanel = $('#'+this.$documentView.currLevel+'-'+id);
...
self._ZEN_Mojo_Plugin_jQM132Helper__Loader = function() {
	zenLoadClass('_ZEN_Mojo_Plugin_baseHelperPlugin');
	_ZEN_Mojo_Plugin_jQM132Helper.prototype = zenCreate('_ZEN_Mojo_Plugin_baseHelperPlugin',-1);
	var p = _ZEN_Mojo_Plugin_jQM132Helper.prototype;
	if (null==p) {return;}
	p.constructor = _ZEN_Mojo_Plugin_jQM132Helper;
	...
	p._serverClass = '%ZEN.Mojo.Plugin.jQM132Helper';
	p._type = 'jQM132Helper';
	p.serialize = _ZEN_Mojo_Plugin_jQM132Helper_serialize;
	p.getSettings = _ZEN_Mojo_Plugin_jQM132Helper_getSettings;
	p.buildOptions = _ZEN_Mojo_Plugin_jQM132Helper_buildOptions;
	p.changeTheme = _ZEN_Mojo_Plugin_jQM132Helper_changeTheme;
	p.closePanel = _ZEN_Mojo_Plugin_jQM132Helper_closePanel;
	p.closePopup = _ZEN_Mojo_Plugin_jQM132Helper_closePopup;
	p.createLayoutObjects = _ZEN_Mojo_Plugin_jQM132Helper_createLayoutObjects;
	p.decorateControl = _ZEN_Mojo_Plugin_jQM132Helper_decorateControl;
	p.getDisplayText = _ZEN_Mojo_Plugin_jQM132Helper_getDisplayText;
	p.getFeatures = _ZEN_Mojo_Plugin_jQM132Helper_getFeatures;
	p.hideElement = _ZEN_Mojo_Plugin_jQM132Helper_hideElement;
	p.onCheckLibraries = _ZEN_Mojo_Plugin_jQM132Helper_onCheckLibraries;
	p.openPanel = _ZEN_Mojo_Plugin_jQM132Helper_openPanel;
	p.refreshButton = _ZEN_Mojo_Plugin_jQM132Helper_refreshButton;
	p.refreshCheckboxRadio = _ZEN_Mojo_Plugin_jQM132Helper_refreshCheckboxRadio;
	p.refreshCollapsible = _ZEN_Mojo_Plugin_jQM132Helper_refreshCollapsible;
	p.refreshCollapsibleSet = _ZEN_Mojo_Plugin_jQM132Helper_refreshCollapsibleSet;
	p.refreshControlGroup = _ZEN_Mojo_Plugin_jQM132Helper_refreshControlGroup;
	p.refreshFieldSet = _ZEN_Mojo_Plugin_jQM132Helper_refreshFieldSet;
	p.refreshFooter = _ZEN_Mojo_Plugin_jQM132Helper_refreshFooter;
	p.refreshHeader = _ZEN_Mojo_Plugin_jQM132Helper_refreshHeader;
	p.refreshInput = _ZEN_Mojo_Plugin_jQM132Helper_refreshInput;
	p.refreshListView = _ZEN_Mojo_Plugin_jQM132Helper_refreshListView;
	p.refreshListViewItem = _ZEN_Mojo_Plugin_jQM132Helper_refreshListViewItem;
	p.refreshPanel = _ZEN_Mojo_Plugin_jQM132Helper_refreshPanel;
	p.refreshPopup = _ZEN_Mojo_Plugin_jQM132Helper_refreshPopup;
	p.refreshRange = _ZEN_Mojo_Plugin_jQM132Helper_refreshRange;
	p.refreshSelect = _ZEN_Mojo_Plugin_jQM132Helper_refreshSelect;
	p.renderButton = _ZEN_Mojo_Plugin_jQM132Helper_renderButton;
	p.renderCheckbox = _ZEN_Mojo_Plugin_jQM132Helper_renderCheckbox;
	p.renderCollapsible = _ZEN_Mojo_Plugin_jQM132Helper_renderCollapsible;
	p.renderCollapsibleSet = _ZEN_Mojo_Plugin_jQM132Helper_renderCollapsibleSet;
	p.renderContentBlock = _ZEN_Mojo_Plugin_jQM132Helper_renderContentBlock;
	p.renderControl = _ZEN_Mojo_Plugin_jQM132Helper_renderControl;
	p.renderControlGroup = _ZEN_Mojo_Plugin_jQM132Helper_renderControlGroup;
	p.renderFieldSet = _ZEN_Mojo_Plugin_jQM132Helper_renderFieldSet;
	p.renderFooter = _ZEN_Mojo_Plugin_jQM132Helper_renderFooter;
	p.renderGrid = _ZEN_Mojo_Plugin_jQM132Helper_renderGrid;
	p.renderHeader = _ZEN_Mojo_Plugin_jQM132Helper_renderHeader;
	p.renderInput = _ZEN_Mojo_Plugin_jQM132Helper_renderInput;
	p.renderLink = _ZEN_Mojo_Plugin_jQM132Helper_renderLink;
	p.renderListView = _ZEN_Mojo_Plugin_jQM132Helper_renderListView;
	p.renderListViewItem = _ZEN_Mojo_Plugin_jQM132Helper_renderListViewItem;
	p.renderNavBar = _ZEN_Mojo_Plugin_jQM132Helper_renderNavBar;
	p.renderNavBarItem = _ZEN_Mojo_Plugin_jQM132Helper_renderNavBarItem;
	p.renderPanel = _ZEN_Mojo_Plugin_jQM132Helper_renderPanel;
	p.renderPopup = _ZEN_Mojo_Plugin_jQM132Helper_renderPopup;
	p.renderRadioButton = _ZEN_Mojo_Plugin_jQM132Helper_renderRadioButton;
	p.renderSelect = _ZEN_Mojo_Plugin_jQM132Helper_renderSelect;
	p.renderTextArea = _ZEN_Mojo_Plugin_jQM132Helper_renderTextArea;
	p.showElement = _ZEN_Mojo_Plugin_jQM132Helper_showElement;
	p.showPopup = _ZEN_Mojo_Plugin_jQM132Helper_showPopup;
	p.togglePanel = _ZEN_Mojo_Plugin_jQM132Helper_togglePanel;
}
/* EOF */