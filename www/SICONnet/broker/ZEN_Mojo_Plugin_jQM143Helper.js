/*** Zen Module: ZEN_Mojo_Plugin_jQM143Helper ***/

self._zenClassIdx['http://www.intersystems.com/zen/mojo/jQM-1.4.3-Helper'] = '_ZEN_Mojo_Plugin_jQM143Helper';
self._ZEN_Mojo_Plugin_jQM143Helper = function(index,id) {
	if (index>=0) {_ZEN_Mojo_Plugin_jQM143Helper__init(this,index,id);}
}

self._ZEN_Mojo_Plugin_jQM143Helper__init = function(o,index,id) {
	...
	o.pluginName = 'jQM-1.4.3-Helper';
	o.version = '1.0.10';
}
function _ZEN_Mojo_Plugin_jQM143Helper_serialize(set,s)
{
...
function _ZEN_Mojo_Plugin_jQM143Helper_getSettings(s)
{
	s['name'] = 'string';
...
self._ZEN_Mojo_Plugin_jQM143Helper_buildOptions = function() {
var html = [];
...
self._ZEN_Mojo_Plugin_jQM143Helper_changeTheme = function(newTheme,headerTheme,barTheme) {
var rmbtnClasses = '';
var rmhfClasses = '';
var rmbdClassess = '';
...
self._ZEN_Mojo_Plugin_jQM143Helper_closePanel = function(id) {
...
self._ZEN_Mojo_Plugin_jQM143Helper_closePopup = function(key) {
$('#'+this.$documentView.getItemByKey(key).$makeId()).popup('close');
}

self._ZEN_Mojo_Plugin_jQM143Helper_createLayoutObjects = function(type,instance) {
...
self._ZEN_Mojo_Plugin_jQM143Helper_decorateControl = function(instance) {
...
self._ZEN_Mojo_Plugin_jQM143Helper_getDisplayText = function() {
var text = '';
var type = this.$type;
switch(type){
case '$button':
...
self._ZEN_Mojo_Plugin_jQM143Helper_getFeatures = function() {
var features = [
...
self._ZEN_Mojo_Plugin_jQM143Helper_hideElement = function(duration,callback) {
...
self._ZEN_Mojo_Plugin_jQM143Helper_onCheckLibraries = function() {
if (typeof $ === 'undefined') {
...
self._ZEN_Mojo_Plugin_jQM143Helper_openPanel = function(id) {
var targetPanel = $('#'+this.$documentView.currLevel+'-'+id);
if (targetPanel.length<1) {
var targetPanel = $('#'+this.$documentView.getItemByKey(id).$makeId());
}
...
self._ZEN_Mojo_Plugin_jQM143Helper_refreshButton = function() {
var options = {};
...
self._ZEN_Mojo_Plugin_jQM143Helper_refreshCheckboxRadio = function() {
var options = {};
var jqmItem = $('#'+this.$makeId());
if (zenGet(this.dataiconpos) !== '') {options['iconpos'] = this.dataiconpos;}
if (zenGet(this.dataTheme) !== '') {options['theme'] = this.dataTheme;}
...
self._ZEN_Mojo_Plugin_jQM143Helper_refreshCollapsible = function() {
var options = {};
var jqmItem = $('#'+this.$makeId());
...
self._ZEN_Mojo_Plugin_jQM143Helper_refreshCollapsibleSet = function() {
var options = {};
var jqmItem = $('#'+this.$makeId());
if (zenGet(this.collapsedicon) !== '') {options['collapsedIcon'] = this.collapsedicon;}
if (zenGet(this.corners) !== '') {options['corners'] = this.corners?true:false;}
...
self._ZEN_Mojo_Plugin_jQM143Helper_refreshControlGroup = function() {
var options = {};
var jqmItem = $('#'+this.$makeId());
...
self._ZEN_Mojo_Plugin_jQM143Helper_refreshFieldSet = function() {
var options = {};
var jqmItem = $('#'+this.$makeId());
if (zenGet(this.dataiconpos) !== '') {options['iconpos'] = this.dataiconpos;}
if (zenGet(this.horizontal) !== '') {options['type'] = this.horizontal?'horizontal':'vertical';}
...
self._ZEN_Mojo_Plugin_jQM143Helper_refreshFooter = function() {
var jqmItem = $('#'+this.$makeId());
...
self._ZEN_Mojo_Plugin_jQM143Helper_refreshGrid = function() {
var jqmItem = $('#'+this.$makeId());
if (zenGet(this.style) !== '') {this.$findElement().setAttribute('style',zenGet(this.style));}
...
self._ZEN_Mojo_Plugin_jQM143Helper_refreshHeader = function() {
var jqmItem = $('#'+this.$makeId());
if (zenGet(this.style) !== '') {this.$findElement().setAttribute('style',zenGet(this.style));}
var caption = zenGet(this.captionContent,this.caption);
if (caption !== '' && jqmItem.children('h1').length > 0) {
...
self._ZEN_Mojo_Plugin_jQM143Helper_refreshInput = function() {
var options = {};
var jqmItem = $('#'+this.$makeId());
...
self._ZEN_Mojo_Plugin_jQM143Helper_refreshLink = function() {
var options = {};
var jqmItem = $('#'+this.$makeId());
if (zenGet(this.dataTheme) !== '') {options['theme'] = this.dataTheme;}
if (zenGet(this.mini) !== '') {options['mini'] = this.mini?true:false;}
...
self._ZEN_Mojo_Plugin_jQM143Helper_refreshListView = function() {
var options = {};
var jqmItem = $('#'+this.$makeId());
if (zenGet(this.dataTheme) !== '') {options['theme'] = this.dataTheme;}
if (zenGet(this.style) !== '') {this.$findElement().setAttribute('style',zenGet(this.style));}
...
self._ZEN_Mojo_Plugin_jQM143Helper_refreshListViewItem = function() {
var options = {};
var jqmItem = $('#'+this.$makeId());
if (zenGet(this.dataTheme) !== '') {options['theme'] = this.dataTheme;}
if (zenGet(this.dataicon) !== '') {options['icon'] = this.dataicon;}
...
self._ZEN_Mojo_Plugin_jQM143Helper_refreshNavBar = function() {
var options = {};
var jqmItem = $('#'+this.$makeId());
if (zenGet(this.dataiconpos) !== '') {options['iconpos'] = this.dataiconpos;}
var parent = jqmItem.parent();
...
self._ZEN_Mojo_Plugin_jQM143Helper_refreshNavBarItem = function() {
var options = {};
var jqmItem = $('#'+this.$makeId());
if (zenGet(this.dataTheme) !== '') {options['theme'] = this.dataTheme;}
if (zenGet(this.dataiconpos) !== '') {options['iconpos'] = this.dataiconpos;}
...
self._ZEN_Mojo_Plugin_jQM143Helper_refreshPanel = function() {
var options = {};
var jqmItem = $('#'+this.$makeId());
if (zenGet(this.dataTheme) !== '') {options['theme'] = this.dataTheme;}
...
self._ZEN_Mojo_Plugin_jQM143Helper_refreshPopup = function() {
var options = {};
var jqmItem = $('#'+this.$makeId());
if (zenGet(this.corners) !== '') {options['corners'] = this.corners?true:false;}
if (zenGet(this.dataTheme) !== '') {options['theme'] = this.dataTheme;}
...
self._ZEN_Mojo_Plugin_jQM143Helper_refreshSelect = function() {
var options = {};
var jqmItem = $('#'+this.$makeId());
if (zenGet(this.controlStyle) !== '') {this.$findElement().setAttribute('style',zenGet(this.controlStyle));}
if (zenGet(this.dataTheme) !== '') {options['theme'] = this.dataTheme;}
...
self._ZEN_Mojo_Plugin_jQM143Helper_renderButton = function() {
var html = [];
...
self._ZEN_Mojo_Plugin_jQM143Helper_renderCheckbox = function() {
var html = [];
...
self._ZEN_Mojo_Plugin_jQM143Helper_renderCollapsible = function() {
var html = [];
var docView = this.$documentView;
var dataTheme = zenGet(this.dataTheme,false) ? 'data-theme="'+this.dataTheme+'"' : '';
...
self._ZEN_Mojo_Plugin_jQM143Helper_renderCollapsibleSet = function() {
var html = [];
var docView = this.$documentView;
var dataTheme = zenGet(this.dataTheme,false) ? 'data-theme="'+this.dataTheme+'"' : '';
...
self._ZEN_Mojo_Plugin_jQM143Helper_renderContentBlock = function() {
var html = [];
var docView = this.$documentView;
var hidden = zenGet(this.hidden,false) ? 'display: none;' : '';
var onSelect = zenGet(this.$ignoreSelect,false) ? '': 'onclick="$$$event(\'click\');"';
...
self._ZEN_Mojo_Plugin_jQM143Helper_renderControl = function() {
var html = [];
var docView = this.$documentView;
...
self._ZEN_Mojo_Plugin_jQM143Helper_renderControlGroup = function() {
var html = [];
var docView = this.$documentView;
...
self._ZEN_Mojo_Plugin_jQM143Helper_renderFieldSet = function() {
var html = [];
var docView = this.$documentView;
var hz = zenGet(this.horizontal,false) ? 'data-type="horizontal"' : '';
var mini = zenGet(this.mini) ? 'data-mini="true"' : '';
...
self._ZEN_Mojo_Plugin_jQM143Helper_renderFooter = function() {
var html = [];
var docView = this.$documentView;
...
self._ZEN_Mojo_Plugin_jQM143Helper_renderGrid = function() {
var html = [];
var docView = this.$documentView;
...
self._ZEN_Mojo_Plugin_jQM143Helper_renderHeader = function() {
var html = [];
var docView = this.$documentView;
var dataTheme = zenGet(this.dataTheme,false) ? 'data-theme="'+this.dataTheme+'"' : 'data-theme="'+this.$documentView.getPluginByLayoutObjectType(this.$type).jQueryHeaderTheme+'"';
var fixed = zenGet(this.fixed,true) ? 'data-position="fixed"' : '';
...
self._ZEN_Mojo_Plugin_jQM143Helper_renderInput = function() {
var html = [];
...
self._ZEN_Mojo_Plugin_jQM143Helper_renderLink = function() {
var html = [];
var mini = zenGet(this.mini) ? 'data-mini="true"' : '';
var hidden = zenGet(this.hidden,false) ? 'display: none;' : '';
var dataTheme = zenGet(this.dataTheme,false) ? 'data-theme="'+this.dataTheme+'"' : '';
...
self._ZEN_Mojo_Plugin_jQM143Helper_renderListView = function() {
var html = [];
var docView = this.$documentView;
...
self._ZEN_Mojo_Plugin_jQM143Helper_renderListViewItem = function() {
var html = [];
var docView = this.$documentView;
...
self._ZEN_Mojo_Plugin_jQM143Helper_renderNavBar = function() {
var html = [];
var docView = this.$documentView;
var dataiconpos = (zenGet(this.dataiconpos,'').length > 0) ? 'data-iconpos="'+zenGet(this.dataiconpos)+'"' : '';
var hidden = zenGet(this.hidden,false) ? 'display: none;' : '';
...
self._ZEN_Mojo_Plugin_jQM143Helper_renderNavBarItem = function() {
var html = [];
var docView = this.$documentView;
this.idAlias = {};
var dataiconpos = (zenGet(this.dataiconpos,'').length > 0) ? 'data-iconpos="'+zenGet(this.dataiconpos)+'"' : '';
...
self._ZEN_Mojo_Plugin_jQM143Helper_renderPanel = function() {
var html = [];
var docView = this.$documentView;
...
self._ZEN_Mojo_Plugin_jQM143Helper_renderPopup = function() {
var html = [];
var docView = this.$documentView;
var dataTheme = zenGet(this.dataTheme,false) ? 'data-theme="'+this.dataTheme+'"' : '';
...
self._ZEN_Mojo_Plugin_jQM143Helper_renderRadioButton = function() {
var html = [];
var value = zenGet(this.value);
...
self._ZEN_Mojo_Plugin_jQM143Helper_renderSelect = function() {
var html = [];
...
self._ZEN_Mojo_Plugin_jQM143Helper_renderTextArea = function() {
var html = [];
var reqd = zenGet(this.required) ? 'required="yes"' : '';
var dis = zenGet(this.disabled) ? 'disabled="yes"' : '';
var mini = zenGet(this.mini) ? 'data-mini="true"' : '';
...
self._ZEN_Mojo_Plugin_jQM143Helper_showElement = function(duration,callback) {
if (this.fieldcontain && $('#'+this.$makeId()).closest('div[data-role="fieldcontain"]').length > 0) {
...
self._ZEN_Mojo_Plugin_jQM143Helper_showPopup = function(key,options) {
if (!options) {
options = {};
}
...
self._ZEN_Mojo_Plugin_jQM143Helper_togglePanel = function(id) {
var targetPanel = $('#'+this.$documentView.currLevel+'-'+id);
...
self._ZEN_Mojo_Plugin_jQM143Helper__Loader = function() {
	zenLoadClass('_ZEN_Mojo_Plugin_baseHelperPlugin');
	_ZEN_Mojo_Plugin_jQM143Helper.prototype = zenCreate('_ZEN_Mojo_Plugin_baseHelperPlugin',-1);
	var p = _ZEN_Mojo_Plugin_jQM143Helper.prototype;
	if (null==p) {return;}
	p.constructor = _ZEN_Mojo_Plugin_jQM143Helper;
	...
	p._serverClass = '%ZEN.Mojo.Plugin.jQM143Helper';
	p._type = 'jQM143Helper';
	p.serialize = _ZEN_Mojo_Plugin_jQM143Helper_serialize;
	p.getSettings = _ZEN_Mojo_Plugin_jQM143Helper_getSettings;
	p.buildOptions = _ZEN_Mojo_Plugin_jQM143Helper_buildOptions;
	p.changeTheme = _ZEN_Mojo_Plugin_jQM143Helper_changeTheme;
	p.closePanel = _ZEN_Mojo_Plugin_jQM143Helper_closePanel;
	p.closePopup = _ZEN_Mojo_Plugin_jQM143Helper_closePopup;
	p.createLayoutObjects = _ZEN_Mojo_Plugin_jQM143Helper_createLayoutObjects;
	p.decorateControl = _ZEN_Mojo_Plugin_jQM143Helper_decorateControl;
	p.getDisplayText = _ZEN_Mojo_Plugin_jQM143Helper_getDisplayText;
	p.getFeatures = _ZEN_Mojo_Plugin_jQM143Helper_getFeatures;
	p.hideElement = _ZEN_Mojo_Plugin_jQM143Helper_hideElement;
	p.onCheckLibraries = _ZEN_Mojo_Plugin_jQM143Helper_onCheckLibraries;
	p.openPanel = _ZEN_Mojo_Plugin_jQM143Helper_openPanel;
	p.refreshButton = _ZEN_Mojo_Plugin_jQM143Helper_refreshButton;
	p.refreshCheckboxRadio = _ZEN_Mojo_Plugin_jQM143Helper_refreshCheckboxRadio;
	p.refreshCollapsible = _ZEN_Mojo_Plugin_jQM143Helper_refreshCollapsible;
	p.refreshCollapsibleSet = _ZEN_Mojo_Plugin_jQM143Helper_refreshCollapsibleSet;
	p.refreshControlGroup = _ZEN_Mojo_Plugin_jQM143Helper_refreshControlGroup;
	p.refreshFieldSet = _ZEN_Mojo_Plugin_jQM143Helper_refreshFieldSet;
	p.refreshFooter = _ZEN_Mojo_Plugin_jQM143Helper_refreshFooter;
	p.refreshGrid = _ZEN_Mojo_Plugin_jQM143Helper_refreshGrid;
	p.refreshHeader = _ZEN_Mojo_Plugin_jQM143Helper_refreshHeader;
	p.refreshInput = _ZEN_Mojo_Plugin_jQM143Helper_refreshInput;
	p.refreshLink = _ZEN_Mojo_Plugin_jQM143Helper_refreshLink;
	p.refreshListView = _ZEN_Mojo_Plugin_jQM143Helper_refreshListView;
	p.refreshListViewItem = _ZEN_Mojo_Plugin_jQM143Helper_refreshListViewItem;
	p.refreshNavBar = _ZEN_Mojo_Plugin_jQM143Helper_refreshNavBar;
	p.refreshNavBarItem = _ZEN_Mojo_Plugin_jQM143Helper_refreshNavBarItem;
	p.refreshPanel = _ZEN_Mojo_Plugin_jQM143Helper_refreshPanel;
	p.refreshPopup = _ZEN_Mojo_Plugin_jQM143Helper_refreshPopup;
	p.refreshSelect = _ZEN_Mojo_Plugin_jQM143Helper_refreshSelect;
	p.renderButton = _ZEN_Mojo_Plugin_jQM143Helper_renderButton;
	p.renderCheckbox = _ZEN_Mojo_Plugin_jQM143Helper_renderCheckbox;
	p.renderCollapsible = _ZEN_Mojo_Plugin_jQM143Helper_renderCollapsible;
	p.renderCollapsibleSet = _ZEN_Mojo_Plugin_jQM143Helper_renderCollapsibleSet;
	p.renderContentBlock = _ZEN_Mojo_Plugin_jQM143Helper_renderContentBlock;
	p.renderControl = _ZEN_Mojo_Plugin_jQM143Helper_renderControl;
	p.renderControlGroup = _ZEN_Mojo_Plugin_jQM143Helper_renderControlGroup;
	p.renderFieldSet = _ZEN_Mojo_Plugin_jQM143Helper_renderFieldSet;
	p.renderFooter = _ZEN_Mojo_Plugin_jQM143Helper_renderFooter;
	p.renderGrid = _ZEN_Mojo_Plugin_jQM143Helper_renderGrid;
	p.renderHeader = _ZEN_Mojo_Plugin_jQM143Helper_renderHeader;
	p.renderInput = _ZEN_Mojo_Plugin_jQM143Helper_renderInput;
	p.renderLink = _ZEN_Mojo_Plugin_jQM143Helper_renderLink;
	p.renderListView = _ZEN_Mojo_Plugin_jQM143Helper_renderListView;
	p.renderListViewItem = _ZEN_Mojo_Plugin_jQM143Helper_renderListViewItem;
	p.renderNavBar = _ZEN_Mojo_Plugin_jQM143Helper_renderNavBar;
	p.renderNavBarItem = _ZEN_Mojo_Plugin_jQM143Helper_renderNavBarItem;
	p.renderPanel = _ZEN_Mojo_Plugin_jQM143Helper_renderPanel;
	p.renderPopup = _ZEN_Mojo_Plugin_jQM143Helper_renderPopup;
	p.renderRadioButton = _ZEN_Mojo_Plugin_jQM143Helper_renderRadioButton;
	p.renderSelect = _ZEN_Mojo_Plugin_jQM143Helper_renderSelect;
	p.renderTextArea = _ZEN_Mojo_Plugin_jQM143Helper_renderTextArea;
	p.showElement = _ZEN_Mojo_Plugin_jQM143Helper_showElement;
	p.showPopup = _ZEN_Mojo_Plugin_jQM143Helper_showPopup;
	p.togglePanel = _ZEN_Mojo_Plugin_jQM143Helper_togglePanel;
}
/* EOF */